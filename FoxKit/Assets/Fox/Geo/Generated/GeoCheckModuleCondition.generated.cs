...
namespace Fox.Geo
{
    ...
    public partial class GeoCheckModuleCondition : Fox.Geo.GeoTrapCondition 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoCheckModuleCondition"), typeof(GeoCheckModuleCondition), new Fox.Geo.GeoTrapCondition().GetClassEntityInfo(), 0, "Trap", 0);
