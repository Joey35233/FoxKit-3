...
namespace Fox.Geo
{
    ...
    public partial class GeoPathFixedPackFile : Fox.Core.RawFile 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoPathFixedPackFile"), typeof(GeoPathFixedPackFile), new Fox.Core.RawFile().GetClassEntityInfo(), 0, null, 0);
        }
