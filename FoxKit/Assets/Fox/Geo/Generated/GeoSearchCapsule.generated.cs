...
namespace Fox.Geo
{
    ...
    public partial class GeoSearchCapsule : Fox.Geo.GeoSearchObject 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoSearchCapsule"), typeof(GeoSearchCapsule), new Fox.Geo.GeoSearchObject().GetClassEntityInfo(), 0, null, 0);
