...
namespace Fox.Ui
{
	...
	public partial class UiModelData : Fox.Core.TransformData
	{
		...
		[field: UnityEngine.SerializeField]
		public CsSystem.Collections.Generic.List<Fox.Ui.UiModelNodeElement> modelNodes { get; private set; } = new CsSystem.Collections.Generic.List<Fox.Ui.UiModelNodeElement>();
		...
		static UiModelData()
		{
			...
			classInfo.AddStaticProperty(new Fox.Core.PropertyInfo("modelNodes", Fox.Core.PropertyInfo.PropertyType.EntityPtr, 424, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, typeof(Fox.Ui.UiModelNodeElement), null, Fox.Core.PropertyInfo.PropertyStorage.Instance, Fox.Core.PropertyInfo.BackingType.Field));
		...
		public override void SetPropertyElement(string propertyName, ushort index, object value)
		{
			switch (propertyName)
			{
				case "animations":
					...
					return;
				case "modelNodes":
					while(this.modelNodes.Count <= index) { this.modelNodes.Add(default(Fox.Ui.UiModelNodeElement)); }
					this.modelNodes[index] = (Fox.Ui.UiModelNodeElement)value;
					return;
				default:
