...
namespace Fox.GameService
{
    ...
    public partial class GsRouteDataEventAimPoint : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GsRouteDataEventAimPoint"), typeof(GsRouteDataEventAimPoint), new Fox.Core.DataElement().GetClassEntityInfo(), 0, null, 0);
        }
