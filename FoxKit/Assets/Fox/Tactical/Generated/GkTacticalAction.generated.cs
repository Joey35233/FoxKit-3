...
namespace Fox.Tactical
{
    ...
    public partial class GkTacticalAction : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GkTacticalAction"), typeof(GkTacticalAction), new Fox.Core.TransformData().GetClassEntityInfo(), 368, "TacticalAction", 7);
