...
namespace Fox.Grx
{
    ...
    public partial class GrReflectionSetting : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GrReflectionSetting"), typeof(GrReflectionSetting), new Fox.Core.Data().GetClassEntityInfo(), 72, "Config", 0);
