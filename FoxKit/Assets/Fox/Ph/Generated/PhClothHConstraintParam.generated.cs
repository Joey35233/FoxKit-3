...
namespace Fox.Ph
{
    ...
    public partial class PhClothHConstraintParam : Fox.Ph.PhConstraintParam 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("PhClothHConstraintParam"), typeof(PhClothHConstraintParam), new Fox.Ph.PhConstraintParam().GetClassEntityInfo(), 0, "Ph", 0);
