...
namespace Fox.Ph
{
    ...
    public partial class PhCylinderConstraintParam : Fox.Ph.PhConstraintParam 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("PhCylinderConstraintParam"), typeof(PhCylinderConstraintParam), new Fox.Ph.PhConstraintParam().GetClassEntityInfo(), 0, "Ph", 0);
