...
namespace Fox.Ph
{
    ...
    public partial class PhPolyhedronShapeParam : Fox.Ph.PhShapeParam 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("PhPolyhedronShapeParam"), typeof(PhPolyhedronShapeParam), new Fox.Ph.PhShapeParam().GetClassEntityInfo(), 0, "Ph", 0);
