...
namespace Fox.Ph
{
    ...
    public partial class PhPrimitiveShapeParam : Fox.Ph.PhShapeParam 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("PhPrimitiveShapeParam"), typeof(PhPrimitiveShapeParam), new Fox.Ph.PhShapeParam().GetClassEntityInfo(), 96, "Ph", 0);
        }
