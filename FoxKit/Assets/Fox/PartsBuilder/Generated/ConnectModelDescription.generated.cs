...
namespace Fox.PartsBuilder
{
	...
	public partial class ConnectModelDescription : Fox.PartsBuilder.ModelDescription
	{
		...
		public override object GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "connectPointNames":
					return (object)(Fox.IStringMap)connectPointNames;
				default:
		...
		public override object GetPropertyElement(string propertyName, string key)
		{
			...
			{
				case "connectPointNames":
					return (object)this.connectPointNames[key];
				default:
			...
			switch (propertyName)
			{
				case "connectPointNames":
					if (this.connectPointNames.ContainsKey(key))
						this.connectPointNames[key] = (string)value;
					else
						this.connectPointNames.Insert(key, (string)value);
					return;
				default:
