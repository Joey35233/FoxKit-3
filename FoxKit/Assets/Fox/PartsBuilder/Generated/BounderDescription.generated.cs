...
namespace Fox.PartsBuilder
{
    ...
    public partial class BounderDescription : Fox.PartsBuilder.PartDescription 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("BounderDescription", typeof(BounderDescription), new Fox.PartsBuilder.PartDescription().GetClassEntityInfo(), 0, "PartsBuilder", 0);
