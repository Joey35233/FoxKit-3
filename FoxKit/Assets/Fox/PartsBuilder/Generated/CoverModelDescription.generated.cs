	...
	public partial class CoverModelDescription : Fox.PartsBuilder.ModelDescription
	{
		...
		static CoverModelDescription()
		{
			if (Fox.PartsBuilder.ModelDescription.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("CoverModelDescription"), typeof(CoverModelDescription), Fox.PartsBuilder.ModelDescription.ClassInfo, 288, "PartsBuilder", 0);
