...
namespace Fox.PartsBuilder
{
    ...
    public partial class FoxOffsetModelDescription : Fox.PartsBuilder.ModelDescription 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("FoxOffsetModelDescription"), typeof(FoxOffsetModelDescription), new Fox.PartsBuilder.ModelDescription().GetClassEntityInfo(), 0, "PartsBuilder", 0);
