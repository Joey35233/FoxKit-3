...
namespace Fox.EdDemo
{
    ...
    public partial class AvatarPhotoTextureLoadParameter : Fox.Demo.DemoParameter 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("AvatarPhotoTextureLoadParameter"), typeof(AvatarPhotoTextureLoadParameter), new Fox.Demo.DemoParameter().GetClassEntityInfo(), 36, null, 0);
        }
