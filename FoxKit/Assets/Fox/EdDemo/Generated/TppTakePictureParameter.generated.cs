...
namespace Fox.EdDemo
{
    ...
    public partial class TppTakePictureParameter : Fox.Demo.DemoParameter 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppTakePictureParameter"), typeof(TppTakePictureParameter), new Fox.Demo.DemoParameter().GetClassEntityInfo(), 32, null, 0);
        }
