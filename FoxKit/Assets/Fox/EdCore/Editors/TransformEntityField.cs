...
namespace Fox.EdCore
{
    ...
    public class TransformEntityField : EntityField<TransformEntity>
    {
        ...
        {
            context.BodyElement.Add(new HelpBox("Required placeholder. Must be direct child of desired TransformData. The Transform of the TransformEntity GameObject is unused.", HelpBoxMessageType.Warning));
        }
    }
}