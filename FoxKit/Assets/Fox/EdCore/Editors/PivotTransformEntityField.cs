...
namespace Fox.EdCore
{
    ...
    public class PivotTransformEntityField : EntityField<PivotTransformEntity>
    {
        ...
        {
            context.Element.Add(new HelpBox("Required placeholder. Must be direct child of desired TransformData. The Transform of the PivotTransformEntity GameObject is unused.", HelpBoxMessageType.Warning));
        }
    }
}