...
#line 57 "..\Gr\Dg\shader\SSLighting_Common.shdr"
...
#line 73 "..\Gr\Dg\shader\SSLighting_Common.shdr"
PSScene			g_psScene;
PSObject		g_psObject;
PSLight			g_psLight;
PSMaterial		g_psMaterial;
PSSystem		g_psSystem;
PSRenderBuffer	g_psRenderBuffer;


#line 82 "..\Gr\Dg\shader\SSLighting_Common.shdr"
...
#line 15 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
inline void NScreenCoordinateToDrawCoordinateForSHSky(float2 inPosition, out float4 outPosition, out float4 outBackBufferSamplingPosition)
{
#line 24 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
	...
	float4	viewToUv = g_vsSystem.m_renderInfo.xyzw * g_vsSystem.m_renderBuffer.zwzw;


	float4	backBufferSamplingPosition = float4(inPosition.xy, 0, 1);

	backBufferSamplingPosition.xy = backBufferSamplingPosition.xy * viewToUv.xy + viewToUv.zw;


#ifndef DG_ENABLE_HALFPIXELOFFSET
	backBufferSamplingPosition.xy += float2(0.5f, 0.5f) * g_vsSystem.m_renderBuffer.zw * backBufferSamplingPosition.w;
#endif

	outBackBufferSamplingPosition = backBufferSamplingPosition;
}



#line 50 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
void vs_main(

	in	float4	inPosition	: POSITION,
	out	float4	outClipSpacePosition : TEXCOORD0,
	out	float4	outBackBufferSamplingPosition : TEXCOORD1,
	out	float4	outPosition : OUT_POSITION
)
{
	#include "../UnityPatch/PreEntryPoint.hlsl"

	float2	NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_inPosition;
	float4 NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outPosition;
	float4 NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outBackBufferSamplingPosition;
#line 63 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
	NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_inPosition = inPosition.xy;
	NScreenCoordinateToDrawCoordinateForSHSky(NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_inPosition, NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outPosition, NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outBackBufferSamplingPosition);


#line 65 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
	outPosition = NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outPosition;

#line 66 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
	outClipSpacePosition = NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outPosition;

#line 67 "..\Gr\Dg\shader\SSLighting_SH_SkyLight.shdr"
	outBackBufferSamplingPosition = NScreenCoordinateToDrawCoordinateForSHSky_drawCoordinate_outBackBufferSamplingPosition;
