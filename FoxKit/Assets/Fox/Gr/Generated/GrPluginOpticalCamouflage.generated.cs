...
namespace Fox.Gr
{
    ...
    public partial class GrPluginOpticalCamouflage : Fox.Gr.GrRenderPlugin 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GrPluginOpticalCamouflage"), typeof(GrPluginOpticalCamouflage), new Fox.Gr.GrRenderPlugin().GetClassEntityInfo(), 0, null, 0);
        }
