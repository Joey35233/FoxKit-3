...
namespace Fox.Geox
{
    ...
    public partial class GeoxPartsTargetOffenseObject : Fox.Geox.GeoxPartsTargetObject 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoxPartsTargetOffenseObject"), typeof(GeoxPartsTargetOffenseObject), new Fox.Geox.GeoxPartsTargetObject().GetClassEntityInfo(), 0, "Target", 1);
