...
namespace Fox.Geox
{
    ...
    public partial class GeoxDynamicBoundingVolumeActivator : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoxDynamicBoundingVolumeActivator"), typeof(GeoxDynamicBoundingVolumeActivator), new Fox.Core.TransformData().GetClassEntityInfo(), 288, null, 0);
