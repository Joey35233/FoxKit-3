	...
	public partial class GeoxDynamicBoundingVolumeActivator : Fox.Core.TransformData
	{
		...
		static GeoxDynamicBoundingVolumeActivator()
		{
			if (Fox.Core.TransformData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoxDynamicBoundingVolumeActivator"), typeof(GeoxDynamicBoundingVolumeActivator), Fox.Core.TransformData.ClassInfo, 288, null, 0);
			classInfo.AddStaticProperty(new Fox.Core.PropertyInfo(new Fox.Kernel.String("gridSize"), Fox.Core.PropertyInfo.PropertyType.Vector3, 304, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance, Fox.Core.PropertyInfo.BackingType.Field));
