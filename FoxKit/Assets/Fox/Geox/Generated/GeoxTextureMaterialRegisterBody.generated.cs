...
namespace Fox.Geox
{
    ...
    public partial class GeoxTextureMaterialRegisterBody : Fox.Core.DataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoxTextureMaterialRegisterBody"), typeof(GeoxTextureMaterialRegisterBody), new Fox.Core.DataBody().GetClassEntityInfo(), 0, "Geox", 0);
        }
