...
namespace Fox.Geox
{
    ...
    public partial class GeoxDynamicBoundingVolumeArea : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GeoxDynamicBoundingVolumeArea"), typeof(GeoxDynamicBoundingVolumeArea), new Fox.Core.TransformData().GetClassEntityInfo(), 256, null, 0);
        }
