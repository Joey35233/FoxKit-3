...
namespace Fox.Nav
{
    ...
    public partial class NavNavigationGraphHandleEntity : Fox.Nav.NavUnitHandleEntity 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavNavigationGraphHandleEntity"), typeof(NavNavigationGraphHandleEntity), new Fox.Nav.NavUnitHandleEntity().GetClassEntityInfo(), 0, "Nav", 0);
