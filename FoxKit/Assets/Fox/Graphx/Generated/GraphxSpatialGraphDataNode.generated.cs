...
namespace Fox.Graphx
{
	...
	public partial class GraphxSpatialGraphDataNode : Fox.Core.DataElement
	{
		...
		[field: UnityEngine.SerializeField]
		public Fox.DynamicArray<Fox.Core.Entity> inlinks { get; private set; } = new Fox.DynamicArray<Fox.Core.Entity>();
		
		[field: UnityEngine.SerializeField]
		public Fox.DynamicArray<Fox.Core.Entity> outlinks { get; private set; } = new Fox.DynamicArray<Fox.Core.Entity>();
