...
namespace Fox.Graphx
{
    ...
    public partial class GraphxSpatialGraphData : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GraphxSpatialGraphData"), typeof(GraphxSpatialGraphData), new Fox.Core.TransformData().GetClassEntityInfo(), 0, "Graphx", 0);
