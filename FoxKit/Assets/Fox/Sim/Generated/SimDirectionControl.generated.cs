...
namespace Fox.Sim
{
    ...
    public partial class SimDirectionControl : Fox.Sim.SimControlElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("SimDirectionControl"), typeof(SimDirectionControl), new Fox.Sim.SimControlElement().GetClassEntityInfo(), 56, "Sim", 1);
