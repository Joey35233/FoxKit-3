...
namespace Fox.Sim
{
    ...
    public partial class SimWindControl : Fox.Sim.SimControlElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("SimWindControl"), typeof(SimWindControl), new Fox.Sim.SimControlElement().GetClassEntityInfo(), 56, "Sim", 0);
