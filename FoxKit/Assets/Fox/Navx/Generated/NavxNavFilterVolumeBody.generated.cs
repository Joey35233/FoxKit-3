...
namespace Fox.Navx
{
    ...
    public partial class NavxNavFilterVolumeBody : Fox.Graphx.GraphxPathVolumeBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavxNavFilterVolumeBody"), typeof(NavxNavFilterVolumeBody), new Fox.Graphx.GraphxPathVolumeBody().GetClassEntityInfo(), 0, null, 0);
        }
