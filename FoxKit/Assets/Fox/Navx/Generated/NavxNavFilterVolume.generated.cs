...
namespace Fox.Navx
{
    ...
    public partial class NavxNavFilterVolume : Fox.Graphx.GraphxPathVolume 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavxNavFilterVolume"), typeof(NavxNavFilterVolume), new Fox.Graphx.GraphxPathVolume().GetClassEntityInfo(), 320, null, 0);
