...
namespace Fox.Navx
{
    ...
    public partial class NavxNavFileConnector : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavxNavFileConnector"), typeof(NavxNavFileConnector), new Fox.Core.TransformData().GetClassEntityInfo(), 0, "Navx", 0);
