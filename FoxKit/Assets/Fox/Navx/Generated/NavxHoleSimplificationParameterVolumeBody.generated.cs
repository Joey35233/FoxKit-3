...
namespace Fox.Navx
{
    ...
    public partial class NavxHoleSimplificationParameterVolumeBody : Fox.Core.TransformDataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavxHoleSimplificationParameterVolumeBody"), typeof(NavxHoleSimplificationParameterVolumeBody), new Fox.Core.TransformDataBody().GetClassEntityInfo(), 0, "Navx", 0);
        }
