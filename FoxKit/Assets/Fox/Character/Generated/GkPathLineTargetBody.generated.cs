...
namespace Fox.Character
{
    ...
    public partial class GkPathLineTargetBody : Fox.Graphx.GraphxPath 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GkPathLineTargetBody"), typeof(GkPathLineTargetBody), new Fox.Graphx.GraphxPath().GetClassEntityInfo(), 0, "Character", 0);
        }
