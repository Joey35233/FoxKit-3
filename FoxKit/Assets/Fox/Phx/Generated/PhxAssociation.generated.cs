...
namespace Fox.Phx
{
	...
	public partial class PhxAssociation : Fox.Core.Data
	{
		...
		[field: UnityEngine.SerializeField]
		public Fox.Kernel.StringMap<Fox.Core.EntityPtr<Fox.Phx.PhxAssociationUnitElement>> connections { get; private set; } = new Fox.Kernel.StringMap<Fox.Core.EntityPtr<Fox.Phx.PhxAssociationUnitElement>>();
