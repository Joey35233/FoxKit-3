...
namespace Fox.GameKit
{
    ...
    public partial class EnvironmentAreaBody : Fox.Core.TransformDataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("EnvironmentAreaBody"), typeof(EnvironmentAreaBody), new Fox.Core.TransformDataBody().GetClassEntityInfo(), 0, null, 1);
