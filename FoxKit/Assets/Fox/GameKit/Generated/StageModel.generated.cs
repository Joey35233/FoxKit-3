	...
	public partial class StageModel : Fox.Core.TransformData
	{
		...
		static StageModel()
		{
			if (Fox.Core.TransformData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("StageModel"), typeof(StageModel), Fox.Core.TransformData.ClassInfo, 0, "Model", 0);
