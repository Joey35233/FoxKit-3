...
namespace Fox.GameKit
{
	...
	public partial class SubtitlesOptionBlockControllerData : Fox.Core.Data
	{
		...
		public Fox.Kernel.DynamicArray<Fox.Kernel.String> packageFileNames { get; private set; } = new Fox.Kernel.DynamicArray<Fox.Kernel.String>();
		...
		static SubtitlesOptionBlockControllerData()
		{
			if (Fox.Core.Data.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("SubtitlesOptionBlockControllerData"), typeof(SubtitlesOptionBlockControllerData), Fox.Core.Data.ClassInfo, 88, "Subtitles", 0);
