...
namespace Fox.GameKit
{
    ...
    public partial class ObjectBrushPluginCloneBody : Fox.GameKit.ObjectBrushPluginBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("ObjectBrushPluginCloneBody"), typeof(ObjectBrushPluginCloneBody), new Fox.GameKit.ObjectBrushPluginBody().GetClassEntityInfo(), 0, "ObjectBrush", 0);
        }
