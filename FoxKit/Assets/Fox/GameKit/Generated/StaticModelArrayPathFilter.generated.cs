...
namespace Fox.GameKit
{
    ...
    public partial class StaticModelArrayPathFilter : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("StaticModelArrayPathFilter"), typeof(StaticModelArrayPathFilter), new Fox.Core.Data().GetClassEntityInfo(), 80, "Model", 1);
