	...
	public partial class EntityHandleArrayPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		static EntityHandleArrayPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("EntityHandleArrayPropertyDifference"), typeof(EntityHandleArrayPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
