...
namespace Fox.Core
{
    ...
    public partial class FoxDataLinkCollectorDataBody : Fox.Core.DataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("FoxDataLinkCollectorDataBody"), typeof(FoxDataLinkCollectorDataBody), new Fox.Core.DataBody().GetClassEntityInfo(), 0, null, 0);
        }
