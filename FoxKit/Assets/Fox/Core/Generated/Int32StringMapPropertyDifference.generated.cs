...
namespace Fox.Core
{
	...
	public partial class Int32StringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		public Fox.Kernel.StringMap<int> originalValues { get; private set; } = new Fox.Kernel.StringMap<int>();
		
		[field: UnityEngine.SerializeField]
		public Fox.Kernel.StringMap<int> values { get; private set; } = new Fox.Kernel.StringMap<int>();
		...
		static Int32StringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("Int32StringMapPropertyDifference"), typeof(Int32StringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
