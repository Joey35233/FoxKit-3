...
namespace Fox.Core
{
    ...
    public partial class Int32StringMapPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("Int32StringMapPropertyDifference", typeof(Int32StringMapPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
