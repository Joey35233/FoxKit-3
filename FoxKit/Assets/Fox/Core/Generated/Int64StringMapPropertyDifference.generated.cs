...
namespace Fox.Core
{
    ...
    public partial class Int64StringMapPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("Int64StringMapPropertyDifference"), typeof(Int64StringMapPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
