...
namespace Fox.Core
{
    ...
    public partial class WideVector3ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("WideVector3ArrayPropertyDifference", typeof(WideVector3ArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
