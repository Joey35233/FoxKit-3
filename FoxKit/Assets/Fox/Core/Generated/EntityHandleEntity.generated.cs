...
namespace Fox.Core
{
    ...
    public partial class EntityHandleEntity : Fox.Core.PropertyValueEntity 
    {
        ...
        protected Fox.Core.EntityHandle value { get; set; }
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("EntityHandleEntity"), typeof(EntityHandleEntity), new Fox.Core.PropertyValueEntity().GetClassEntityInfo(), 0, null, 0);
