			...
			switch (propertyName)
			{
				case "originalValues":
					if (this.originalValues.ContainsKey(key))
						this.originalValues[key] = (UnityEngine.Matrix4x4)value;
					else
						this.originalValues.Insert(key, (UnityEngine.Matrix4x4)value);
					return;
				case "values":
					if (this.values.ContainsKey(key))
						this.values[key] = (UnityEngine.Matrix4x4)value;
					else
						this.values.Insert(key, (UnityEngine.Matrix4x4)value);
					return;
				default:
