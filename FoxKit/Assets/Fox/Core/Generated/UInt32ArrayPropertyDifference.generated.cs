...
namespace Fox.Core
{
    ...
    public partial class UInt32ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("UInt32ArrayPropertyDifference"), typeof(UInt32ArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
