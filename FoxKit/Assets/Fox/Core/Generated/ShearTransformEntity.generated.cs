...
namespace Fox.Core
{
    ...
    public partial class ShearTransformEntity : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("ShearTransformEntity"), typeof(ShearTransformEntity), new Fox.Core.DataElement().GetClassEntityInfo(), 48, null, 0);
