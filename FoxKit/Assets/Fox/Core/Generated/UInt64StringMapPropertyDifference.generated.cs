...
namespace Fox.Core
{
	...
	public partial class UInt64StringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		public Fox.Kernel.StringMap<ulong> originalValues { get; private set; } = new Fox.Kernel.StringMap<ulong>();
		
		[field: UnityEngine.SerializeField]
		public Fox.Kernel.StringMap<ulong> values { get; private set; } = new Fox.Kernel.StringMap<ulong>();
		...
		static UInt64StringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("UInt64StringMapPropertyDifference"), typeof(UInt64StringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
