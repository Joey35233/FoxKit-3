	...
	public partial class Matrix3ArrayPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		static Matrix3ArrayPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("Matrix3ArrayPropertyDifference"), typeof(Matrix3ArrayPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
