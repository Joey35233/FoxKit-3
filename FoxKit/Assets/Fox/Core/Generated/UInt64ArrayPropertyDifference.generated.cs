...
namespace Fox.Core
{
    ...
    public partial class UInt64ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("UInt64ArrayPropertyDifference"), typeof(UInt64ArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
