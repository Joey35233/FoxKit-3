...
namespace Fox.Core
{
    ...
    public partial class BoolStringMapPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("BoolStringMapPropertyDifference"), typeof(BoolStringMapPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
