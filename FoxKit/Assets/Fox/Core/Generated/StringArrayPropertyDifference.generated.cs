...
namespace Fox.Core
{
    ...
    public partial class StringArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("StringArrayPropertyDifference", typeof(StringArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
