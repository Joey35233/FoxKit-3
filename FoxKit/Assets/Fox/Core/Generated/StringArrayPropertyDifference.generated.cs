...
namespace Fox.Core
{
	...
	public partial class StringArrayPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		public Fox.Kernel.DynamicArray<Fox.Kernel.String> originalValues { get; private set; } = new Fox.Kernel.DynamicArray<Fox.Kernel.String>();
		
		[field: UnityEngine.SerializeField]
		public Fox.Kernel.DynamicArray<Fox.Kernel.String> values { get; private set; } = new Fox.Kernel.DynamicArray<Fox.Kernel.String>();
		...
		static StringArrayPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("StringArrayPropertyDifference"), typeof(StringArrayPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
