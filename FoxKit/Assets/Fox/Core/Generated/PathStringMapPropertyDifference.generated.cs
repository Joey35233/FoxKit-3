...
namespace Fox.Core
{
	...
	public partial class PathStringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		public Fox.Kernel.StringMap<Fox.Kernel.Path> originalValues { get; private set; } = new Fox.Kernel.StringMap<Fox.Kernel.Path>();
		
		[field: UnityEngine.SerializeField]
		public Fox.Kernel.StringMap<Fox.Kernel.Path> values { get; private set; } = new Fox.Kernel.StringMap<Fox.Kernel.Path>();
		...
		static PathStringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("PathStringMapPropertyDifference"), typeof(PathStringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
