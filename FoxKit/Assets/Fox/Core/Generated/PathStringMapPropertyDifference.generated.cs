			...
			switch (propertyName)
			{
				case "originalValues":
					if (this.originalValues.ContainsKey(key))
						this.originalValues[key] = (Fox.Path)value;
					else
						this.originalValues.Insert(key, (Fox.Path)value);
					return;
				case "values":
					if (this.values.ContainsKey(key))
						this.values[key] = (Fox.Path)value;
					else
						this.values.Insert(key, (Fox.Path)value);
					return;
				default:
