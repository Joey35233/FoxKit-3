...
namespace Fox.Core
{
    ...
    public partial class UInt16ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("UInt16ArrayPropertyDifference"), typeof(UInt16ArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
