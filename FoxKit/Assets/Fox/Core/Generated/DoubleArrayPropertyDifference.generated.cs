...
namespace Fox.Core
{
    ...
    public partial class DoubleArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("DoubleArrayPropertyDifference"), typeof(DoubleArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
