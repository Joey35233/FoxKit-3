...
namespace Fox.Core
{
    ...
    public partial class Int32ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("Int32ArrayPropertyDifference"), typeof(Int32ArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
