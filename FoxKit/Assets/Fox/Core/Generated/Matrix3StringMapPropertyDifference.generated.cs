			...
			switch (propertyName)
			{
				case "originalValues":
					if (this.originalValues.ContainsKey(key))
						this.originalValues[key] = (Fox.Matrix3x3)value;
					else
						this.originalValues.Insert(key, (Fox.Matrix3x3)value);
					return;
				case "values":
					if (this.values.ContainsKey(key))
						this.values[key] = (Fox.Matrix3x3)value;
					else
						this.values.Insert(key, (Fox.Matrix3x3)value);
					return;
				default:
