...
namespace Fox.Core
{
    ...
    public partial class QuatArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("QuatArrayPropertyDifference", typeof(QuatArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
