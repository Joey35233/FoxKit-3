			...
			switch (propertyName)
			{
				case "originalValues":
					if (this.originalValues.ContainsKey(key))
						this.originalValues[key] = (UnityEngine.Vector3)value;
					else
						this.originalValues.Insert(key, (UnityEngine.Vector3)value);
					return;
				case "values":
					if (this.values.ContainsKey(key))
						this.values[key] = (UnityEngine.Vector3)value;
					else
						this.values.Insert(key, (UnityEngine.Vector3)value);
					return;
				default:
