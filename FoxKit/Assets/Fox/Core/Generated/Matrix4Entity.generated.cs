...
namespace Fox.Core
{
    ...
    public partial class Matrix4Entity : Fox.Core.PropertyValueEntity 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("Matrix4Entity"), typeof(Matrix4Entity), new Fox.Core.PropertyValueEntity().GetClassEntityInfo(), 0, null, 0);
