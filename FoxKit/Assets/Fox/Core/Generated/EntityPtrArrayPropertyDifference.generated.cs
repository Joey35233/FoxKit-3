...
namespace Fox.Core
{
    ...
    public partial class EntityPtrArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("EntityPtrArrayPropertyDifference", typeof(EntityPtrArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
