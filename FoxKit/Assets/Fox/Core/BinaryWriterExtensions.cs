...
namespace Fox.Core
{
    public static class BinaryWriterExtensions
    {
        ...
        {
            Entity val = entity.GetProperty<Entity>(property);
            ulong address = 0;
            if (val != null)
            {
        ...
        public static void WriteEntityHandle(this BinaryWriter writer, Entity val, IDictionary<Entity, ulong> addresses)
        {
            ulong address = 0;
            if (val != null)
            {
        ...
        public static List<Kernel.String> WriteEntityLinkPropertyValue(this BinaryWriter writer, Entity entity, PropertyInfo property, IDictionary<Entity, ulong> addresses)
        {
            ...
            ulong address = 0;
            if (entityLinkVal.handle != null)
            {
                address = addresses[entityLinkVal.handle];
            }
