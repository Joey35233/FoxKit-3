...
namespace Fox.Editor
{
    ...
    {
        private static readonly StyleSheet FoxFieldLightStyleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Fox/Core/Editor/FoxFieldLight.uss");
        private static readonly StyleSheet FoxFieldDarkStyleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Fox/Core/Editor/FoxFieldDark.uss");
