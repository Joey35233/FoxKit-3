...
namespace Fox.Core
{
    public static class EditorColors
    {
        ...
        public static readonly Color AudioSelectedColor = new(0.5f, 0.95f, 0.95f, 0.85f);
        public static readonly Color AudioUnselectedColor = new(0.5f, 0.95f, 0.95f, 0.25f);
