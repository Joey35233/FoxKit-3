	...
	public partial class GameObjectLocatorBody : Fox.Core.TransformDataBody
	{
		...
		static GameObjectLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GameObjectLocatorBody"), typeof(GameObjectLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
