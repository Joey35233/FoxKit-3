...
namespace Fox.GameCore
{
    ...
    public partial class GameObjectLocatorBody : Fox.Core.TransformDataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GameObjectLocatorBody"), typeof(GameObjectLocatorBody), new Fox.Core.TransformDataBody().GetClassEntityInfo(), 0, null, 0);
        }
