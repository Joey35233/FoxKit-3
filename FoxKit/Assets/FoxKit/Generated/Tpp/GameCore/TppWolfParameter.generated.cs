...
namespace Tpp.GameCore
{
    ...
    public partial class TppWolfParameter : Fox.Core.DataElement 
    {
        ...
        static TppWolfParameter()
        {
			...
			classInfo.StaticProperties.Insert("mogFile", new Fox.Core.PropertyInfo("mogFile", Fox.Core.PropertyInfo.PropertyType.FilePtr, 112, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
