...
namespace Tpp.Effect
{
    ...
    public partial class TppPrimRiverModel : Fox.Core.Data 
    {
        ...
        static TppPrimRiverModel()
        {
			...
			classInfo.StaticProperties.Insert("staticModels", new Fox.Core.PropertyInfo("staticModels", Fox.Core.PropertyInfo.PropertyType.EntityLink, 144, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        }
