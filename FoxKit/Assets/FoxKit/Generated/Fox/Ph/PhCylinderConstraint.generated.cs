...
namespace Fox.Ph
{
    ...
    public partial class PhCylinderConstraint : Fox.Ph.PhConstraint 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("PhCylinderConstraint", typeof(PhCylinderConstraint), new Fox.Ph.PhConstraint().GetClassEntityInfo(), 0, "Ph", 0);
			...
			classInfo.StaticProperties.Insert("heightMin", new Fox.Core.PropertyInfo("heightMin", Fox.Core.PropertyInfo.PropertyType.Float, 0, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
			classInfo.StaticProperties.Insert("heightMax", new Fox.Core.PropertyInfo("heightMax", Fox.Core.PropertyInfo.PropertyType.Float, 0, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        }
