...
namespace Fox.Core
{
    ...
    public partial class StringListEntity : Fox.Core.Entity 
    {
        ...
        static StringListEntity()
        {
			...
			classInfo.StaticProperties.Insert("list", new Fox.Core.PropertyInfo("list", Fox.Core.PropertyInfo.PropertyType.String, 48, 1, Fox.Core.PropertyInfo.ContainerType.List, Fox.Core.PropertyInfo.PropertyExport.Never, Fox.Core.PropertyInfo.PropertyExport.Never, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        }
