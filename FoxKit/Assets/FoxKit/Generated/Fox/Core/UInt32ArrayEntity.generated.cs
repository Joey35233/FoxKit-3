...
namespace Fox.Core
{
    ...
    public partial class UInt32ArrayEntity : Fox.Core.Entity 
    {
        ...
        static UInt32ArrayEntity()
        {
			...
			classInfo.StaticProperties.Insert("array", new Fox.Core.PropertyInfo("array", Fox.Core.PropertyInfo.PropertyType.UInt32, 48, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorOnly, Fox.Core.PropertyInfo.PropertyExport.EditorOnly, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        }
