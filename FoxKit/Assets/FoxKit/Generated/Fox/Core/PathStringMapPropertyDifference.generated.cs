...
namespace Fox.Core
{
    ...
    public partial class PathStringMapPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        public Fox.FoxKernel.StringMap<Fox.FoxKernel.Path> originalValues { get; set; } = new Fox.FoxKernel.StringMap<Fox.FoxKernel.Path>();
        
        [field: UnityEngine.SerializeField]
        public Fox.FoxKernel.StringMap<Fox.FoxKernel.Path> values { get; set; } = new Fox.FoxKernel.StringMap<Fox.FoxKernel.Path>();
