...
namespace Fox.Core
{
    ...
    public partial class PathArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("PathArrayPropertyDifference", typeof(PathArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
