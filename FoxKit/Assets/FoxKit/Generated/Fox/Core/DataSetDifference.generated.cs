...
namespace Fox.Core
{
    ...
    public partial class DataSetDifference : Fox.Core.Entity 
    {
        ...
        protected Fox.Core.StringMap<Fox.Core.EntityPtr<Fox.Core.EntityDifference>> dataList { get; set; } = new Fox.Core.StringMap<Fox.Core.EntityPtr<Fox.Core.EntityDifference>>();
