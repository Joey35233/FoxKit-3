...
namespace Fox.Core
{
    ...
    public partial class UInt64ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        static UInt64ArrayPropertyDifference()
        {
			...
			classInfo.StaticProperties.Insert("originalValues", new Fox.Core.PropertyInfo("originalValues", Fox.Core.PropertyInfo.PropertyType.UInt64, 72, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorOnly, Fox.Core.PropertyInfo.PropertyExport.EditorOnly, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
			classInfo.StaticProperties.Insert("values", new Fox.Core.PropertyInfo("values", Fox.Core.PropertyInfo.PropertyType.UInt64, 88, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorOnly, Fox.Core.PropertyInfo.PropertyExport.EditorOnly, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        }
