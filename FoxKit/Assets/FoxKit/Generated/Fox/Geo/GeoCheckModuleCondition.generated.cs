...
namespace Fox.Geo
{
    ...
    public partial class GeoCheckModuleCondition : Fox.Geo.GeoTrapCondition 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("GeoCheckModuleCondition", typeof(GeoCheckModuleCondition), new Fox.Geo.GeoTrapCondition().GetClassEntityInfo(), 0, "Trap", 0);
			...
			classInfo.StaticProperties.Insert("checkCallbackDataElements", new Fox.Core.PropertyInfo("checkCallbackDataElements", Fox.Core.PropertyInfo.PropertyType.EntityPtr, 344, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.Never, typeof(Fox.Geo.GeoTrapModuleCallbackDataElement), null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        }
