...
namespace Fox.Ph
{
    public partial class PhActionParam : Fox.Core.Entity 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("PhActionParam", new Fox.Core.Entity(0, 0, 0).GetClassEntityInfo(), 0, "Ph", 0);
        ...
        // Constructor
		public PhActionParam(ulong address, ushort idA, ushort idB) : base(address, idA, idB) { }
