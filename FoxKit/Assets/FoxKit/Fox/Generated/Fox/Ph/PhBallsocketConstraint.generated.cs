...
namespace Fox.Ph
{
    public partial class PhBallsocketConstraint : Fox.Ph.PhConstraint 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("PhBallsocketConstraint", new Fox.Ph.PhConstraint().GetClassEntityInfo(), 0, "Ph", 0);
        ...
        // Constructors
		public PhBallsocketConstraint(ulong address, ulong id) : base(address, id) { }
