...
namespace Fox.Core
{
    public partial class PassiveBlockControllerData : Fox.Core.Data 
    {
        ...
        public bool loadWithDataProperty;
        ...
        static PassiveBlockControllerData()
        {
			...
			classInfo.StaticProperties.Insert("blockGroups", new Fox.Core.PropertyInfo(Fox.Core.PropertyInfo.PropertyType.EntityLink, 136, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
