...
namespace Fox.Core
{
    ...
    {
        // Properties
        public CsSystem.Collections.Generic.List<Fox.Core.EntityPtr<Fox.Core.Entity>> originalValues = new CsSystem.Collections.Generic.List<Fox.Core.EntityPtr<Fox.Core.Entity>>();
        
        public CsSystem.Collections.Generic.List<Fox.Core.EntityPtr<Fox.Core.Entity>> values = new CsSystem.Collections.Generic.List<Fox.Core.EntityPtr<Fox.Core.Entity>>();
