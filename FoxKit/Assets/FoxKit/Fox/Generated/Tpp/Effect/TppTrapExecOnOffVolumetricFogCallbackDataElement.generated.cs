...
namespace Tpp.Effect
{
    public partial class TppTrapExecOnOffVolumetricFogCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppTrapExecOnOffVolumetricFogCallbackDataElement", new Fox.Geo.GeoTrapModuleCallbackDataElement(0, 0, 0).GetClassEntityInfo(), 0, null, 0);
