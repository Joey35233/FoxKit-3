...
namespace Tpp.GameCore
{
    public partial class TppCorpseParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppCorpseParameter", new Fox.Core.DataElement(0, 0, 0).GetClassEntityInfo(), 176, null, 0);
        ...
        // Constructor
		public TppCorpseParameter(ulong address, ushort idA, ushort idB) : base(address, idA, idB) { }
