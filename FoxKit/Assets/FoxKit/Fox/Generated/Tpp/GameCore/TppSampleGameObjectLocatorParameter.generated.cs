...
namespace Tpp.GameCore
{
    public partial class TppSampleGameObjectLocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppSampleGameObjectLocatorParameter", new Fox.Core.DataElement().GetClassEntityInfo(), 0, null, 0);
        ...
        // Constructors
		public TppSampleGameObjectLocatorParameter(ulong address, ulong id) : base(address, id) { }
