...
namespace Tpp.GameCore
{
    public partial class TppBuddyDog2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppBuddyDog2LocatorParameter", new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppBuddyDog2LocatorParameter(ulong address, ulong id) : base(address, id) { }
