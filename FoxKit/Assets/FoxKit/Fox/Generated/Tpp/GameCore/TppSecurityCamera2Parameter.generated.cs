...
namespace Tpp.GameCore
{
    public partial class TppSecurityCamera2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppSecurityCamera2Parameter", new Fox.Core.DataElement().GetClassEntityInfo(), 104, null, 0);
        ...
        // Constructors
		public TppSecurityCamera2Parameter(ulong address, ulong id) : base(address, id) { }
