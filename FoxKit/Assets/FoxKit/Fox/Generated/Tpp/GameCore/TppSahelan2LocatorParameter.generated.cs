...
namespace Tpp.GameCore
{
    public partial class TppSahelan2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppSahelan2LocatorParameter", new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppSahelan2LocatorParameter(ulong address, ulong id) : base(address, id) { }
