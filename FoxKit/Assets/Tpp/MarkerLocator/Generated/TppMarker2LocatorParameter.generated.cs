...
namespace Tpp.MarkerLocator
{
	...
	public partial class TppMarker2LocatorParameter : Fox.Core.DataElement
	{
		...
		public Fox.Kernel.String markerType { get; set; }
		
		[field: UnityEngine.SerializeField]
		public Fox.Kernel.String markerId { get; set; }
		...
		static TppMarker2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppMarker2LocatorParameter"), typeof(TppMarker2LocatorParameter), Fox.Core.DataElement.ClassInfo, 36, null, 0);
