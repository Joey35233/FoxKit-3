...
namespace Tpp.Effect
{
    ...
    public partial class TppLensFlareShape : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppLensFlareShape"), typeof(TppLensFlareShape), new Fox.Core.TransformData().GetClassEntityInfo(), 672, null, 11);
