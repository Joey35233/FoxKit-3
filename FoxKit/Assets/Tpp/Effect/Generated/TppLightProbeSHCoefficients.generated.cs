...
namespace Tpp.Effect
{
    ...
    public partial class TppLightProbeSHCoefficients : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppLightProbeSHCoefficients"), typeof(TppLightProbeSHCoefficients), new Fox.Core.Data().GetClassEntityInfo(), 104, "Light", 1);
