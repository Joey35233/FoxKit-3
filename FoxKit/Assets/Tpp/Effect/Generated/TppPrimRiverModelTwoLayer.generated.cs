...
namespace Tpp.Effect
{
    ...
    public partial class TppPrimRiverModelTwoLayer : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppPrimRiverModelTwoLayer"), typeof(TppPrimRiverModelTwoLayer), new Fox.Core.Data().GetClassEntityInfo(), 120, null, 0);
