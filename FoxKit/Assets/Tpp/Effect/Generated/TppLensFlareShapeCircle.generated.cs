	...
	public partial class TppLensFlareShapeCircle : Tpp.Effect.TppLensFlareShape
	{
		...
		static TppLensFlareShapeCircle()
		{
			if (Tpp.Effect.TppLensFlareShape.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppLensFlareShapeCircle"), typeof(TppLensFlareShapeCircle), Tpp.Effect.TppLensFlareShape.ClassInfo, 688, null, 1);
