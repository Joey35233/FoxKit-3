...
namespace Tpp.Effect
{
    ...
    public partial class TppPrimRiverModelParamTwoLayer : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppPrimRiverModelParamTwoLayer"), typeof(TppPrimRiverModelParamTwoLayer), new Fox.Core.Data().GetClassEntityInfo(), 224, null, 4);
