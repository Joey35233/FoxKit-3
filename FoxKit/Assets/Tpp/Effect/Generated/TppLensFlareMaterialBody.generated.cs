...
namespace Tpp.Effect
{
    ...
    public partial class TppLensFlareMaterialBody : Fox.Core.DataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppLensFlareMaterialBody"), typeof(TppLensFlareMaterialBody), new Fox.Core.DataBody().GetClassEntityInfo(), 0, null, 0);
        }
