...
namespace Tpp.Effect
{
    ...
    public partial class TppSkyClouds3Param : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppSkyClouds3Param"), typeof(TppSkyClouds3Param), new Fox.Core.DataElement().GetClassEntityInfo(), 0, "TppEffect", 3);
