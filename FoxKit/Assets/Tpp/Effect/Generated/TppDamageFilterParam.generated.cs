...
namespace Tpp.Effect
{
    ...
    public partial class TppDamageFilterParam : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppDamageFilterParam"), typeof(TppDamageFilterParam), new Fox.Core.TransformData().GetClassEntityInfo(), 336, null, 0);
