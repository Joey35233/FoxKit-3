		...
		public override void SetProperty(string propertyName, object value)
		{
			switch (propertyName)
			{
				case "identify":
					...
					return;
				case "videoFormat":
					this.videoFormat = (string)value;
					return;
				case "videoWidth":
					this.videoWidth = (uint)value;
					return;
				case "videoHeight":
					this.videoHeight = (uint)value;
					return;
				case "videoAllocateSize":
					this.videoAllocateSize = (uint)value;
					return;
				default:
