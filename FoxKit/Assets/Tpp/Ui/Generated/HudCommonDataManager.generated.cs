...
namespace Tpp.Ui
{
    ...
    public partial class HudCommonDataManager : Fox.Core.Entity 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("HudCommonDataManager"), typeof(HudCommonDataManager), new Fox.Core.Entity().GetClassEntityInfo(), 0, null, 0);
        }
