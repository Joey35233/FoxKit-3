...
namespace Tpp.GameCore
{
    ...
    public partial class TppRat2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRat2LocatorParameter"), typeof(TppRat2LocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 36, null, 0);
