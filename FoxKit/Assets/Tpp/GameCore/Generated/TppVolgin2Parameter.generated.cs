...
namespace Tpp.GameCore
{
    ...
    public partial class TppVolgin2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppVolgin2Parameter"), typeof(TppVolgin2Parameter), new Fox.Core.DataElement().GetClassEntityInfo(), 104, null, 0);
