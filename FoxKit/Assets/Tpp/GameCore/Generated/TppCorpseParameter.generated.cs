...
namespace Tpp.GameCore
{
    ...
    public partial class TppCorpseParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppCorpseParameter"), typeof(TppCorpseParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 176, null, 0);
