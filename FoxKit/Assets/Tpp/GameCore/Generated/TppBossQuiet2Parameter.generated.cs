...
namespace Tpp.GameCore
{
    ...
    public partial class TppBossQuiet2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppBossQuiet2Parameter"), typeof(TppBossQuiet2Parameter), new Fox.Core.DataElement().GetClassEntityInfo(), 176, null, 0);
