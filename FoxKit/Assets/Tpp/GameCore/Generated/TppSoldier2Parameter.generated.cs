...
namespace Tpp.GameCore
{
    ...
    public partial class TppSoldier2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppSoldier2Parameter"), typeof(TppSoldier2Parameter), new Fox.Core.DataElement().GetClassEntityInfo(), 176, null, 3);
