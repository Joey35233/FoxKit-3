	...
	public partial class TppWalkerGear2Parameter : Fox.Core.DataElement
	{
		...
		public override object GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				...
				case "extensionMtarFile":
					return (object)extensionMtarFile;
				case "vfxFiles":
					return (object)(Fox.IStringMap)vfxFiles;
				case "extraPartsFiles":
					return (object)(Fox.IStringMap)extraPartsFiles;
				default:
		...
		public override object GetPropertyElement(string propertyName, string key)
		{
			switch (propertyName)
			{
				...
				case "extraPartsFiles":
					return (object)this.extraPartsFiles[key];
				default:
		...
		public override void SetProperty(string propertyName, object value)
		{
			switch (propertyName)
			{
				...
				case "mtarFile":
					...
					return;
				case "extensionMtarFile":
					this.extensionMtarFile = (Fox.Core.FilePtr)value;
					return;
				default:
			...
			switch (propertyName)
			{
				...
				case "extraPartsFiles":
					if (this.extraPartsFiles.ContainsKey(key))
						this.extraPartsFiles[key] = (Fox.Core.FilePtr)value;
					else
						this.extraPartsFiles.Insert(key, (Fox.Core.FilePtr)value);
					return;
				default:
