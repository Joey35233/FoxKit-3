	...
	public partial class TppAnimalLocatorParameter : Fox.Core.DataElement
	{
		...
		static TppAnimalLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppAnimalLocatorParameter"), typeof(TppAnimalLocatorParameter), Fox.Core.DataElement.ClassInfo, 40, null, 1);
