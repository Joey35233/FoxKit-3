...
namespace Tpp.GameCore
{
    ...
    public partial class TppParasite2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppParasite2Parameter"), typeof(TppParasite2Parameter), new Fox.Core.DataElement().GetClassEntityInfo(), 344, null, 3);
