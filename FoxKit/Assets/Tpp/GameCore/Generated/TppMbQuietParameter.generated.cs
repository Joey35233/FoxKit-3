...
namespace Tpp.GameCore
{
    ...
    public partial class TppMbQuietParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppMbQuietParameter"), typeof(TppMbQuietParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 176, null, 0);
