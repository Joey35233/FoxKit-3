...
namespace Tpp.GameCore
{
    ...
    public partial class TppHorse2forVrParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppHorse2forVrParameter"), typeof(TppHorse2forVrParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 152, null, 0);
