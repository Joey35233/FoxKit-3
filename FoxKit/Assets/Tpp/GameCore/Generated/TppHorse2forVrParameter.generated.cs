	...
	public partial class TppHorse2forVrParameter : Fox.Core.DataElement
	{
		...
		static TppHorse2forVrParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppHorse2forVrParameter"), typeof(TppHorse2forVrParameter), Fox.Core.DataElement.ClassInfo, 152, null, 0);
