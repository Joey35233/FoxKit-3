...
namespace Tpp.GameCore
{
    ...
    public partial class TppBuddyPuppyParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppBuddyPuppyParameter"), typeof(TppBuddyPuppyParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 168, null, 1);
