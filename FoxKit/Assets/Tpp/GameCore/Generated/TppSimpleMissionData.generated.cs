...
namespace Tpp.GameCore
{
    ...
    public partial class TppSimpleMissionData : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppSimpleMissionData"), typeof(TppSimpleMissionData), new Fox.Core.Data().GetClassEntityInfo(), 136, null, 1);
