...
namespace Tpp.GameCore
{
    ...
    public partial class TppWolfLocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppWolfLocatorParameter"), typeof(TppWolfLocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 40, null, 0);
