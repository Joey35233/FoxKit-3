...
namespace Tpp.GameCore
{
    ...
    public partial class TppSahelan2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppSahelan2LocatorParameter", typeof(TppSahelan2LocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
