...
namespace Tpp.GameCore
{
    ...
    public partial class TppLiquid2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppLiquid2Parameter"), typeof(TppLiquid2Parameter), new Fox.Core.DataElement().GetClassEntityInfo(), 104, null, 0);
