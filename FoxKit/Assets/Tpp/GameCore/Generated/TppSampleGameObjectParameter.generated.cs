...
namespace Tpp.GameCore
{
    ...
    public partial class TppSampleGameObjectParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppSampleGameObjectParameter", typeof(TppSampleGameObjectParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 0, null, 0);
