...
namespace Tpp.GameCore
{
    ...
    public partial class TppMotherBaseContainerLocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppMotherBaseContainerLocatorParameter"), typeof(TppMotherBaseContainerLocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 0, null, 0);
