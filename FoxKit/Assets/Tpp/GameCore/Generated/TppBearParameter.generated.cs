...
namespace Tpp.GameCore
{
    ...
    public partial class TppBearParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppBearParameter"), typeof(TppBearParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 120, null, 1);
