...
namespace Tpp.GameCore
{
    ...
    public partial class TppHostage2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppHostage2Parameter"), typeof(TppHostage2Parameter), new Fox.Core.DataElement().GetClassEntityInfo(), 176, null, 1);
