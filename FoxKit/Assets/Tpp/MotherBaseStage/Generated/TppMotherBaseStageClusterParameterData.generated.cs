...
namespace Tpp.MotherBaseStage
{
    ...
    public partial class TppMotherBaseStageClusterParameterData : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppMotherBaseStageClusterParameterData", typeof(TppMotherBaseStageClusterParameterData), new Fox.Core.Data().GetClassEntityInfo(), 496, null, 3);
