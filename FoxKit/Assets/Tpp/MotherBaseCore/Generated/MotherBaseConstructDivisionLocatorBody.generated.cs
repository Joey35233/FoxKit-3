	...
	public partial class MotherBaseConstructDivisionLocatorBody : Fox.Core.TransformDataBody
	{
		...
		static MotherBaseConstructDivisionLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("MotherBaseConstructDivisionLocatorBody"), typeof(MotherBaseConstructDivisionLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "TppMotherBase", 0);
