...
namespace Tpp.MotherBaseCore
{
    ...
    public partial class MotherBaseConstructDivisionLocatorBody : Fox.Core.TransformDataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("MotherBaseConstructDivisionLocatorBody", typeof(MotherBaseConstructDivisionLocatorBody), new Fox.Core.TransformDataBody().GetClassEntityInfo(), 0, "TppMotherBase", 0);
        }
