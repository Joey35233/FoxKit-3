...
namespace Tpp.MotherBaseCore
{
    ...
    public partial class MotherBaseConstructConnectLocator : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("MotherBaseConstructConnectLocator"), typeof(MotherBaseConstructConnectLocator), new Fox.Core.TransformData().GetClassEntityInfo(), 272, "TppMotherBase", 1);
