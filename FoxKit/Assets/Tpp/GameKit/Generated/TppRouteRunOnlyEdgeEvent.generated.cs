...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteRunOnlyEdgeEvent")]
	public partial class TppRouteRunOnlyEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteRunOnlyEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteRunOnlyEdgeEvent", typeof(TppRouteRunOnlyEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
