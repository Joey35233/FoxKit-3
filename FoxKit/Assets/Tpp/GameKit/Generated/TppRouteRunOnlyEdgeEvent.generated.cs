...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteRunOnlyEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteRunOnlyEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteRunOnlyEdgeEvent"), typeof(TppRouteRunOnlyEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteRunOnlyEdgeEvent(ulong id) : base(id) { }
		public TppRouteRunOnlyEdgeEvent() : base() { }
