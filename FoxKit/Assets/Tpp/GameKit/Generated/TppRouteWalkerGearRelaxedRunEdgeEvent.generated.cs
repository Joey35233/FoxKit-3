...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWalkerGearRelaxedRunEdgeEvent")]
	public partial class TppRouteWalkerGearRelaxedRunEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteWalkerGearRelaxedRunEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWalkerGearRelaxedRunEdgeEvent", typeof(TppRouteWalkerGearRelaxedRunEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
