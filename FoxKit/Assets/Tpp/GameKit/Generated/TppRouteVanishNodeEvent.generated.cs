...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteVanishNodeEvent")]
	public partial class TppRouteVanishNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteVanishNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteVanishNodeEvent", typeof(TppRouteVanishNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
