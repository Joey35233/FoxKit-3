...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteVanishNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteVanishNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteVanishNodeEvent"), typeof(TppRouteVanishNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteVanishNodeEvent(ulong id) : base(id) { }
		public TppRouteVanishNodeEvent() : base() { }
