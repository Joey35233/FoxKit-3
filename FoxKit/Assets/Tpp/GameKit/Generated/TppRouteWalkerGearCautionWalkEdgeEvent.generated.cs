...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWalkerGearCautionWalkEdgeEvent")]
	public partial class TppRouteWalkerGearCautionWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteWalkerGearCautionWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWalkerGearCautionWalkEdgeEvent", typeof(TppRouteWalkerGearCautionWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
