	...
	public partial class TppRouteFireNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteFireNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteFireNodeEvent"), typeof(TppRouteFireNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteFireNodeEvent(ulong id) : base(id) { }
		public TppRouteFireNodeEvent() : base() { }
