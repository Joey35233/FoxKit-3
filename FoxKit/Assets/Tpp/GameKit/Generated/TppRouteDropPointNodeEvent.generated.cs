...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteDropPointNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteDropPointNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteDropPointNodeEvent"), typeof(TppRouteDropPointNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteDropPointNodeEvent(ulong id) : base(id) { }
		public TppRouteDropPointNodeEvent() : base() { }
