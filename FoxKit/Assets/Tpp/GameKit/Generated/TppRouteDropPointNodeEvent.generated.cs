...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteDropPointNodeEvent")]
	public partial class TppRouteDropPointNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteDropPointNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteDropPointNodeEvent", typeof(TppRouteDropPointNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
