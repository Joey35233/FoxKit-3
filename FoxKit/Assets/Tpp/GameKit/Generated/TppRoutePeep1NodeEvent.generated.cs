...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRoutePeep1NodeEvent")]
	public partial class TppRoutePeep1NodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRoutePeep1NodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRoutePeep1NodeEvent", typeof(TppRoutePeep1NodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
