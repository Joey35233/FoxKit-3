...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionStandIdleReadyNodeEvent")]
	public partial class TppRouteCautionStandIdleReadyNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCautionStandIdleReadyNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionStandIdleReadyNodeEvent", typeof(TppRouteCautionStandIdleReadyNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
