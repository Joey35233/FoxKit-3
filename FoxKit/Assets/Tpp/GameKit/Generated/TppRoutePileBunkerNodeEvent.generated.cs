...
namespace Tpp.GameKit
{
	...
	public partial class TppRoutePileBunkerNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRoutePileBunkerNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRoutePileBunkerNodeEvent"), typeof(TppRoutePileBunkerNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRoutePileBunkerNodeEvent(ulong id) : base(id) { }
		public TppRoutePileBunkerNodeEvent() : base() { }
