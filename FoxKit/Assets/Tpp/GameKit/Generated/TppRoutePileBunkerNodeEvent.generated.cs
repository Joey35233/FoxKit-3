...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRoutePileBunkerNodeEvent")]
	public partial class TppRoutePileBunkerNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRoutePileBunkerNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRoutePileBunkerNodeEvent", typeof(TppRoutePileBunkerNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
