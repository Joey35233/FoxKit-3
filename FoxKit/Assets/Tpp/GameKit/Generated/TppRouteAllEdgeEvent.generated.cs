...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteAllEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteAllEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteAllEdgeEvent"), typeof(TppRouteAllEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteAllEdgeEvent(ulong id) : base(id) { }
		public TppRouteAllEdgeEvent() : base() { }
