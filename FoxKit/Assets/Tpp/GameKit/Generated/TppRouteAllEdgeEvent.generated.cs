...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteAllEdgeEvent")]
	public partial class TppRouteAllEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteAllEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteAllEdgeEvent", typeof(TppRouteAllEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
