	...
	public partial class TppRouteVehicleIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteVehicleIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteVehicleIdleNodeEvent"), typeof(TppRouteVehicleIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteVehicleIdleNodeEvent(ulong id) : base(id) { }
		public TppRouteVehicleIdleNodeEvent() : base() { }
