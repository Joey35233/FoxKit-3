...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteWaitIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteWaitIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteWaitIdleNodeEvent"), typeof(TppRouteWaitIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteWaitIdleNodeEvent(ulong id) : base(id) { }
		public TppRouteWaitIdleNodeEvent() : base() { }
