...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWaitIdleNodeEvent")]
	public partial class TppRouteWaitIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteWaitIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWaitIdleNodeEvent", typeof(TppRouteWaitIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
