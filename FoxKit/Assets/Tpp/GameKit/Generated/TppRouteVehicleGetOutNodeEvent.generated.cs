...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteVehicleGetOutNodeEvent")]
	public partial class TppRouteVehicleGetOutNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteVehicleGetOutNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteVehicleGetOutNodeEvent", typeof(TppRouteVehicleGetOutNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
