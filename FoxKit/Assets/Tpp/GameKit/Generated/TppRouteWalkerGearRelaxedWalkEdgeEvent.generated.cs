...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWalkerGearRelaxedWalkEdgeEvent")]
	public partial class TppRouteWalkerGearRelaxedWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteWalkerGearRelaxedWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWalkerGearRelaxedWalkEdgeEvent", typeof(TppRouteWalkerGearRelaxedWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
