...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteStandIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteStandIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteStandIdleNodeEvent"), typeof(TppRouteStandIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteStandIdleNodeEvent(ulong id) : base(id) { }
		public TppRouteStandIdleNodeEvent() : base() { }
