...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteStandIdleNodeEvent")]
	public partial class TppRouteStandIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteStandIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteStandIdleNodeEvent", typeof(TppRouteStandIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
