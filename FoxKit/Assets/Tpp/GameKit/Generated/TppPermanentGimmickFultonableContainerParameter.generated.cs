	...
	public partial class TppPermanentGimmickFultonableContainerParameter : Fox.Core.DataElement
	{
		...
		static TppPermanentGimmickFultonableContainerParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppPermanentGimmickFultonableContainerParameter"), typeof(TppPermanentGimmickFultonableContainerParameter), Fox.Core.DataElement.ClassInfo, 0, null, 0);
