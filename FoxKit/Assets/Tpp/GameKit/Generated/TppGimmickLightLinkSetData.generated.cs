...
namespace Tpp.GameKit
{
    ...
    public partial class TppGimmickLightLinkSetData : Fox.Core.Data 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppGimmickLightLinkSetData"), typeof(TppGimmickLightLinkSetData), new Fox.Core.Data().GetClassEntityInfo(), 136, "Gimmick", 1);
