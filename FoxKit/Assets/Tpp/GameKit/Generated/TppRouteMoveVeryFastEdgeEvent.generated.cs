...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteMoveVeryFastEdgeEvent")]
	public partial class TppRouteMoveVeryFastEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteMoveVeryFastEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteMoveVeryFastEdgeEvent", typeof(TppRouteMoveVeryFastEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
