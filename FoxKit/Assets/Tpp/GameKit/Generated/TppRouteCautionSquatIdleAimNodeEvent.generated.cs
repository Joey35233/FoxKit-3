...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionSquatIdleAimNodeEvent")]
	public partial class TppRouteCautionSquatIdleAimNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCautionSquatIdleAimNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionSquatIdleAimNodeEvent", typeof(TppRouteCautionSquatIdleAimNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
