...
namespace Tpp.GameKit
{
	...
	public partial class TppRoutePermitGettingOffEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRoutePermitGettingOffEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRoutePermitGettingOffEdgeEvent"), typeof(TppRoutePermitGettingOffEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRoutePermitGettingOffEdgeEvent(ulong id) : base(id) { }
		public TppRoutePermitGettingOffEdgeEvent() : base() { }
