...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteOnTheHillNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteOnTheHillNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteOnTheHillNodeEvent"), typeof(TppRouteOnTheHillNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteOnTheHillNodeEvent(ulong id) : base(id) { }
		public TppRouteOnTheHillNodeEvent() : base() { }
