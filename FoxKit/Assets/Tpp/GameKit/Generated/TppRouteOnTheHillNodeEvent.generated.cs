...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteOnTheHillNodeEvent")]
	public partial class TppRouteOnTheHillNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteOnTheHillNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteOnTheHillNodeEvent", typeof(TppRouteOnTheHillNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
