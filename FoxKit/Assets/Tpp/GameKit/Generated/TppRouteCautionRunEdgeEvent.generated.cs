...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionRunEdgeEvent")]
	public partial class TppRouteCautionRunEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteCautionRunEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionRunEdgeEvent", typeof(TppRouteCautionRunEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
