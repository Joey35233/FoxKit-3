...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteCautionRunEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteCautionRunEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteCautionRunEdgeEvent"), typeof(TppRouteCautionRunEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteCautionRunEdgeEvent(ulong id) : base(id) { }
		public TppRouteCautionRunEdgeEvent() : base() { }
