...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRoutePickUpHoneyBeeNodeEvent")]
	public partial class TppRoutePickUpHoneyBeeNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRoutePickUpHoneyBeeNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRoutePickUpHoneyBeeNodeEvent", typeof(TppRoutePickUpHoneyBeeNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
