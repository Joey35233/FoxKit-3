...
namespace Tpp.GameKit
{
    ...
    public partial class ObjectBrushPluginSkeletonModelBody : Fox.GameKit.ObjectBrushPluginBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("ObjectBrushPluginSkeletonModelBody"), typeof(ObjectBrushPluginSkeletonModelBody), new Fox.GameKit.ObjectBrushPluginBody().GetClassEntityInfo(), 0, "TppObjectBrushSkeletonModel", 0);
        }
