...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteHeliIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteHeliIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteHeliIdleNodeEvent"), typeof(TppRouteHeliIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteHeliIdleNodeEvent(ulong id) : base(id) { }
		public TppRouteHeliIdleNodeEvent() : base() { }
