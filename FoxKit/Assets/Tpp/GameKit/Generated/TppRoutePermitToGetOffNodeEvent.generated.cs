...
namespace Tpp.GameKit
{
	...
	public partial class TppRoutePermitToGetOffNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRoutePermitToGetOffNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRoutePermitToGetOffNodeEvent"), typeof(TppRoutePermitToGetOffNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRoutePermitToGetOffNodeEvent(ulong id) : base(id) { }
		public TppRoutePermitToGetOffNodeEvent() : base() { }
