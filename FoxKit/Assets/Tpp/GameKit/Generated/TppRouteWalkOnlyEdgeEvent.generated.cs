...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWalkOnlyEdgeEvent")]
	public partial class TppRouteWalkOnlyEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteWalkOnlyEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWalkOnlyEdgeEvent", typeof(TppRouteWalkOnlyEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
