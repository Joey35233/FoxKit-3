...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteWalkOnlyEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteWalkOnlyEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteWalkOnlyEdgeEvent"), typeof(TppRouteWalkOnlyEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteWalkOnlyEdgeEvent(ulong id) : base(id) { }
		public TppRouteWalkOnlyEdgeEvent() : base() { }
