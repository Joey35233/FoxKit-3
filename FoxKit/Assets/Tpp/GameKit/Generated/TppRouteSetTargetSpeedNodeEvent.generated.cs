...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteSetTargetSpeedNodeEvent")]
	public partial class TppRouteSetTargetSpeedNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSetTargetSpeedNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteSetTargetSpeedNodeEvent", typeof(TppRouteSetTargetSpeedNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
