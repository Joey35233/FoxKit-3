...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteRelaxedStandWalkEdgeEvent")]
	public partial class TppRouteRelaxedStandWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteRelaxedStandWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteRelaxedStandWalkEdgeEvent", typeof(TppRouteRelaxedStandWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
