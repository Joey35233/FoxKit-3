...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionWalkAimEdgeEvent")]
	public partial class TppRouteCautionWalkAimEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteCautionWalkAimEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionWalkAimEdgeEvent", typeof(TppRouteCautionWalkAimEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
