...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteRouteMoveEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteRouteMoveEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteRouteMoveEdgeEvent"), typeof(TppRouteRouteMoveEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteRouteMoveEdgeEvent(ulong id) : base(id) { }
		public TppRouteRouteMoveEdgeEvent() : base() { }
