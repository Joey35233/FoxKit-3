...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteRouteMoveEdgeEvent")]
	public partial class TppRouteRouteMoveEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteRouteMoveEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteRouteMoveEdgeEvent", typeof(TppRouteRouteMoveEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
