	...
	public partial class TppRouteSitInChairNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSitInChairNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteSitInChairNodeEvent"), typeof(TppRouteSitInChairNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteSitInChairNodeEvent(ulong id) : base(id) { }
		public TppRouteSitInChairNodeEvent() : base() { }
