...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteKillNodeEvent")]
	public partial class TppRouteKillNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteKillNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteKillNodeEvent", typeof(TppRouteKillNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
