...
namespace Tpp.GameKit
{
    ...
    public partial class TppPermanentGimmickGatlingGunParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppPermanentGimmickGatlingGunParameter", typeof(TppPermanentGimmickGatlingGunParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 80, null, 0);
