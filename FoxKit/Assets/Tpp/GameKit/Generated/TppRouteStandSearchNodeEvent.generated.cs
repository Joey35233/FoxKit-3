...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteStandSearchNodeEvent")]
	public partial class TppRouteStandSearchNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteStandSearchNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteStandSearchNodeEvent", typeof(TppRouteStandSearchNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
