...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteSaluteGreetingNodeEvent")]
	public partial class TppRouteSaluteGreetingNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSaluteGreetingNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteSaluteGreetingNodeEvent", typeof(TppRouteSaluteGreetingNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
