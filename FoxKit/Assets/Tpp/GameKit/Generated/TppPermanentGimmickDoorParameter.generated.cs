...
namespace Tpp.GameKit
{
    ...
    public partial class TppPermanentGimmickDoorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppPermanentGimmickDoorParameter", typeof(TppPermanentGimmickDoorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
