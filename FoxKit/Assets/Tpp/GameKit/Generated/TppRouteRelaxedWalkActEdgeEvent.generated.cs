...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteRelaxedWalkActEdgeEvent")]
	public partial class TppRouteRelaxedWalkActEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteRelaxedWalkActEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteRelaxedWalkActEdgeEvent", typeof(TppRouteRelaxedWalkActEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
