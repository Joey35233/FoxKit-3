...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionStandIdleAimNodeEvent")]
	public partial class TppRouteCautionStandIdleAimNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCautionStandIdleAimNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionStandIdleAimNodeEvent", typeof(TppRouteCautionStandIdleAimNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
