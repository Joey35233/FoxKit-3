...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteUseFlashLightNodeEvent")]
	public partial class TppRouteUseFlashLightNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteUseFlashLightNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteUseFlashLightNodeEvent", typeof(TppRouteUseFlashLightNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
