	...
	public partial class TppRouteVehicleBackNormalEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteVehicleBackNormalEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteVehicleBackNormalEdgeEvent"), typeof(TppRouteVehicleBackNormalEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteVehicleBackNormalEdgeEvent(ulong id) : base(id) { }
		public TppRouteVehicleBackNormalEdgeEvent() : base() { }
