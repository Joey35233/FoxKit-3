...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteJumpOnlyEdgeEvent")]
	public partial class TppRouteJumpOnlyEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteJumpOnlyEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteJumpOnlyEdgeEvent", typeof(TppRouteJumpOnlyEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
