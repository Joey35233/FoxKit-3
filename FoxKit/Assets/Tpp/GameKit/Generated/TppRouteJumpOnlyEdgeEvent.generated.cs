...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteJumpOnlyEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteJumpOnlyEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteJumpOnlyEdgeEvent"), typeof(TppRouteJumpOnlyEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteJumpOnlyEdgeEvent(ulong id) : base(id) { }
		public TppRouteJumpOnlyEdgeEvent() : base() { }
