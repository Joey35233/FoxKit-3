...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteCarryHoneyBeeEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteCarryHoneyBeeEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteCarryHoneyBeeEdgeEvent"), typeof(TppRouteCarryHoneyBeeEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteCarryHoneyBeeEdgeEvent(ulong id) : base(id) { }
		public TppRouteCarryHoneyBeeEdgeEvent() : base() { }
