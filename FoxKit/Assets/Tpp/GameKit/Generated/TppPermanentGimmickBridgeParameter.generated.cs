...
namespace Tpp.GameKit
{
    ...
    public partial class TppPermanentGimmickBridgeParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppPermanentGimmickBridgeParameter", typeof(TppPermanentGimmickBridgeParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
