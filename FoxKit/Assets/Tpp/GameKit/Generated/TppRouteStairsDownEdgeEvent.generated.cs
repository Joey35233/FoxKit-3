...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteStairsDownEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteStairsDownEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteStairsDownEdgeEvent"), typeof(TppRouteStairsDownEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteStairsDownEdgeEvent(ulong id) : base(id) { }
		public TppRouteStairsDownEdgeEvent() : base() { }
