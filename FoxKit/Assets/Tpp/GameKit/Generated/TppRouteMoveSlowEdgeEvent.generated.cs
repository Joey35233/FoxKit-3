...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteMoveSlowEdgeEvent")]
	public partial class TppRouteMoveSlowEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteMoveSlowEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteMoveSlowEdgeEvent", typeof(TppRouteMoveSlowEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
