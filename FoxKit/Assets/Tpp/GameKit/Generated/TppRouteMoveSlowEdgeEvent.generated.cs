...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteMoveSlowEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteMoveSlowEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteMoveSlowEdgeEvent"), typeof(TppRouteMoveSlowEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteMoveSlowEdgeEvent(ulong id) : base(id) { }
		public TppRouteMoveSlowEdgeEvent() : base() { }
