...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteLOWERCASE_moveEdgeEvent")]
	public partial class TppRouteLOWERCASE_moveEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteLOWERCASE_moveEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteLOWERCASE_moveEdgeEvent", typeof(TppRouteLOWERCASE_moveEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
