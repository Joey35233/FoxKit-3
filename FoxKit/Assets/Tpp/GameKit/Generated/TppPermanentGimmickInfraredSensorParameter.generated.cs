...
namespace Tpp.GameKit
{
    ...
    public partial class TppPermanentGimmickInfraredSensorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("TppPermanentGimmickInfraredSensorParameter", typeof(TppPermanentGimmickInfraredSensorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
