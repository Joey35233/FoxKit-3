...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRoutechaseEdgeEvent")]
	public partial class TppRoutechaseEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRoutechaseEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRoutechaseEdgeEvent", typeof(TppRoutechaseEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
