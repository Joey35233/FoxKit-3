...
namespace Tpp.GameKit
{
	...
	public partial class TppRoutechaseEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRoutechaseEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRoutechaseEdgeEvent"), typeof(TppRoutechaseEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRoutechaseEdgeEvent(ulong id) : base(id) { }
		public TppRoutechaseEdgeEvent() : base() { }
