...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteJumpWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteJumpWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteJumpWalkEdgeEvent"), typeof(TppRouteJumpWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteJumpWalkEdgeEvent(ulong id) : base(id) { }
		public TppRouteJumpWalkEdgeEvent() : base() { }
