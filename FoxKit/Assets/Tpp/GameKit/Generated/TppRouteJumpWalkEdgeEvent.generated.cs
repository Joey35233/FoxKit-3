...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteJumpWalkEdgeEvent")]
	public partial class TppRouteJumpWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteJumpWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteJumpWalkEdgeEvent", typeof(TppRouteJumpWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
