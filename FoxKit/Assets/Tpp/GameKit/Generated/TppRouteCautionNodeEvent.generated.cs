...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteCautionNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteCautionNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteCautionNodeEvent"), typeof(TppRouteCautionNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteCautionNodeEvent(ulong id) : base(id) { }
		public TppRouteCautionNodeEvent() : base() { }
