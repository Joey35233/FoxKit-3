...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionNodeEvent")]
	public partial class TppRouteCautionNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCautionNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionNodeEvent", typeof(TppRouteCautionNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
