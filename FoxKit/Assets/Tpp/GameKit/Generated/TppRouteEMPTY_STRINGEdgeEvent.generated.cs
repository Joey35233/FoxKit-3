...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteEMPTY_STRINGEdgeEvent")]
	public partial class TppRouteEMPTY_STRINGEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteEMPTY_STRINGEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteEMPTY_STRINGEdgeEvent", typeof(TppRouteEMPTY_STRINGEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
