...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteDemoNodeEvent")]
	public partial class TppRouteDemoNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteDemoNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteDemoNodeEvent", typeof(TppRouteDemoNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
