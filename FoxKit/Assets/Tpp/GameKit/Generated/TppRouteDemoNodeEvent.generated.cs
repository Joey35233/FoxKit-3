...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteDemoNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteDemoNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteDemoNodeEvent"), typeof(TppRouteDemoNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteDemoNodeEvent(ulong id) : base(id) { }
		public TppRouteDemoNodeEvent() : base() { }
