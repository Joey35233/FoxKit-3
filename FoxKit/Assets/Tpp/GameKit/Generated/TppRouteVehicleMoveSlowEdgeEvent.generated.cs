	...
	public partial class TppRouteVehicleMoveSlowEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteVehicleMoveSlowEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteVehicleMoveSlowEdgeEvent"), typeof(TppRouteVehicleMoveSlowEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
