...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteHoveringNodeEvent")]
	public partial class TppRouteHoveringNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteHoveringNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteHoveringNodeEvent", typeof(TppRouteHoveringNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
