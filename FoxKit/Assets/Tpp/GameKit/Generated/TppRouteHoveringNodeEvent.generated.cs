...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteHoveringNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteHoveringNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteHoveringNodeEvent"), typeof(TppRouteHoveringNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteHoveringNodeEvent(ulong id) : base(id) { }
		public TppRouteHoveringNodeEvent() : base() { }
