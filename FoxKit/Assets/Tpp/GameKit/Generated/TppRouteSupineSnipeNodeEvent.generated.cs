...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteSupineSnipeNodeEvent")]
	public partial class TppRouteSupineSnipeNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSupineSnipeNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteSupineSnipeNodeEvent", typeof(TppRouteSupineSnipeNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
