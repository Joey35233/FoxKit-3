...
namespace Tpp.GameKit
{
    ...
    public partial class ObjectBrushPluginBushDataElement : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("ObjectBrushPluginBushDataElement"), typeof(ObjectBrushPluginBushDataElement), new Fox.Core.DataElement().GetClassEntityInfo(), 224, null, 20);
