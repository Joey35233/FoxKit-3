...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteSnipeNodeEvent")]
	public partial class TppRouteSnipeNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSnipeNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteSnipeNodeEvent", typeof(TppRouteSnipeNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
