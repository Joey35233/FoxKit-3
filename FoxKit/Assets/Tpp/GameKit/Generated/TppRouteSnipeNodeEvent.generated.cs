...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteSnipeNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteSnipeNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteSnipeNodeEvent"), typeof(TppRouteSnipeNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteSnipeNodeEvent(ulong id) : base(id) { }
		public TppRouteSnipeNodeEvent() : base() { }
