...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteMoveFastEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteMoveFastEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteMoveFastEdgeEvent"), typeof(TppRouteMoveFastEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteMoveFastEdgeEvent(ulong id) : base(id) { }
		public TppRouteMoveFastEdgeEvent() : base() { }
