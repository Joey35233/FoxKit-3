...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteMoveFastEdgeEvent")]
	public partial class TppRouteMoveFastEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteMoveFastEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteMoveFastEdgeEvent", typeof(TppRouteMoveFastEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
