...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteOpenDoorNodeEvent")]
	public partial class TppRouteOpenDoorNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteOpenDoorNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteOpenDoorNodeEvent", typeof(TppRouteOpenDoorNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
