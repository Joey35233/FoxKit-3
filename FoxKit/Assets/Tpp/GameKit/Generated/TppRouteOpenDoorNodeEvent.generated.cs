...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteOpenDoorNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteOpenDoorNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteOpenDoorNodeEvent"), typeof(TppRouteOpenDoorNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteOpenDoorNodeEvent(ulong id) : base(id) { }
		public TppRouteOpenDoorNodeEvent() : base() { }
