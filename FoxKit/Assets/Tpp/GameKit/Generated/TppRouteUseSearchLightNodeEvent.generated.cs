...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteUseSearchLightNodeEvent")]
	public partial class TppRouteUseSearchLightNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteUseSearchLightNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteUseSearchLightNodeEvent", typeof(TppRouteUseSearchLightNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
