...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteRelaxedRunEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteRelaxedRunEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteRelaxedRunEdgeEvent"), typeof(TppRouteRelaxedRunEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteRelaxedRunEdgeEvent(ulong id) : base(id) { }
		public TppRouteRelaxedRunEdgeEvent() : base() { }
