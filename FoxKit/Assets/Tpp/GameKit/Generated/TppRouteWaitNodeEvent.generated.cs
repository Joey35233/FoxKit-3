...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteWaitNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteWaitNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteWaitNodeEvent"), typeof(TppRouteWaitNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteWaitNodeEvent(ulong id) : base(id) { }
		public TppRouteWaitNodeEvent() : base() { }
