...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWaitNodeEvent")]
	public partial class TppRouteWaitNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteWaitNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWaitNodeEvent", typeof(TppRouteWaitNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
