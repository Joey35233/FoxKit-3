...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteMoveNormalEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteMoveNormalEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteMoveNormalEdgeEvent"), typeof(TppRouteMoveNormalEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteMoveNormalEdgeEvent(ulong id) : base(id) { }
		public TppRouteMoveNormalEdgeEvent() : base() { }
