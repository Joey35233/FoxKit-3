...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteMoveNormalEdgeEvent")]
	public partial class TppRouteMoveNormalEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteMoveNormalEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteMoveNormalEdgeEvent", typeof(TppRouteMoveNormalEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
