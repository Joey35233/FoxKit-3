...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteDashEdgeEvent")]
	public partial class TppRouteDashEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteDashEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteDashEdgeEvent", typeof(TppRouteDashEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
