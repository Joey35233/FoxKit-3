...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteDashEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteDashEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteDashEdgeEvent"), typeof(TppRouteDashEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteDashEdgeEvent(ulong id) : base(id) { }
		public TppRouteDashEdgeEvent() : base() { }
