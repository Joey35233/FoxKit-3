...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteCurtainInNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteCurtainInNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteCurtainInNodeEvent"), typeof(TppRouteCurtainInNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteCurtainInNodeEvent(ulong id) : base(id) { }
		public TppRouteCurtainInNodeEvent() : base() { }
