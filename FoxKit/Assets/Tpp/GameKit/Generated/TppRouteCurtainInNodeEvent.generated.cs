...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCurtainInNodeEvent")]
	public partial class TppRouteCurtainInNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCurtainInNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCurtainInNodeEvent", typeof(TppRouteCurtainInNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
