...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCloseDoorNodeEvent")]
	public partial class TppRouteCloseDoorNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCloseDoorNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCloseDoorNodeEvent", typeof(TppRouteCloseDoorNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
