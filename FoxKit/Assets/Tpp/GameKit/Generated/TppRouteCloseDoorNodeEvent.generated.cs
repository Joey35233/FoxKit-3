...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteCloseDoorNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteCloseDoorNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteCloseDoorNodeEvent"), typeof(TppRouteCloseDoorNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteCloseDoorNodeEvent(ulong id) : base(id) { }
		public TppRouteCloseDoorNodeEvent() : base() { }
