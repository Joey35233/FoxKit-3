...
namespace Tpp.GameKit
{
    ...
    public partial class CyprusBlockLoadPointDataBody : Fox.Core.DataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("CyprusBlockLoadPointDataBody"), typeof(CyprusBlockLoadPointDataBody), new Fox.Core.DataBody().GetClassEntityInfo(), 0, null, 0);
        }
