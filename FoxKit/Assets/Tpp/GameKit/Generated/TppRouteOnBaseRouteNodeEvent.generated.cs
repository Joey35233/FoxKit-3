...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteOnBaseRouteNodeEvent")]
	public partial class TppRouteOnBaseRouteNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteOnBaseRouteNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteOnBaseRouteNodeEvent", typeof(TppRouteOnBaseRouteNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
