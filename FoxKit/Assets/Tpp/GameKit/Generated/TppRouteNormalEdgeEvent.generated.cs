...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteNormalEdgeEvent")]
	public partial class TppRouteNormalEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteNormalEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteNormalEdgeEvent", typeof(TppRouteNormalEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
