...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteNormalEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteNormalEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteNormalEdgeEvent"), typeof(TppRouteNormalEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteNormalEdgeEvent(ulong id) : base(id) { }
		public TppRouteNormalEdgeEvent() : base() { }
