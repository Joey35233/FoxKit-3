...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionWalkFireEdgeEvent")]
	public partial class TppRouteCautionWalkFireEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteCautionWalkFireEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionWalkFireEdgeEvent", typeof(TppRouteCautionWalkFireEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
