...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteVehicleGetOffNodeEvent")]
	public partial class TppRouteVehicleGetOffNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteVehicleGetOffNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteVehicleGetOffNodeEvent", typeof(TppRouteVehicleGetOffNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
