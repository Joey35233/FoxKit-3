...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteVehicleFireNodeEvent")]
	public partial class TppRouteVehicleFireNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteVehicleFireNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteVehicleFireNodeEvent", typeof(TppRouteVehicleFireNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
