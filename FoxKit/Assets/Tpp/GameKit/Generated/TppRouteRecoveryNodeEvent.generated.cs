...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteRecoveryNodeEvent")]
	public partial class TppRouteRecoveryNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteRecoveryNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteRecoveryNodeEvent", typeof(TppRouteRecoveryNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
