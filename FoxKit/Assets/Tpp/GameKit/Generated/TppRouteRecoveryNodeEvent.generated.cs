...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteRecoveryNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteRecoveryNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteRecoveryNodeEvent"), typeof(TppRouteRecoveryNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteRecoveryNodeEvent(ulong id) : base(id) { }
		public TppRouteRecoveryNodeEvent() : base() { }
