...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteUseFlashLightAlwaysNodeEvent")]
	public partial class TppRouteUseFlashLightAlwaysNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteUseFlashLightAlwaysNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteUseFlashLightAlwaysNodeEvent", typeof(TppRouteUseFlashLightAlwaysNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
