...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteRunWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteRunWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteRunWalkEdgeEvent"), typeof(TppRouteRunWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteRunWalkEdgeEvent(ulong id) : base(id) { }
		public TppRouteRunWalkEdgeEvent() : base() { }
