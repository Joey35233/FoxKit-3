...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteRunWalkEdgeEvent")]
	public partial class TppRouteRunWalkEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteRunWalkEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteRunWalkEdgeEvent", typeof(TppRouteRunWalkEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
