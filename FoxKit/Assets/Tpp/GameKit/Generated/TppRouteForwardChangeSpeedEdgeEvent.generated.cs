...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteForwardChangeSpeedEdgeEvent")]
	public partial class TppRouteForwardChangeSpeedEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteForwardChangeSpeedEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteForwardChangeSpeedEdgeEvent", typeof(TppRouteForwardChangeSpeedEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
