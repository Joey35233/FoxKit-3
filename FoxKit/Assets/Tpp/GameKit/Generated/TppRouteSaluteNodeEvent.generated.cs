...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteSaluteNodeEvent")]
	public partial class TppRouteSaluteNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSaluteNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteSaluteNodeEvent", typeof(TppRouteSaluteNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
