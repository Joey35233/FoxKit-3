...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteSaluteNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteSaluteNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteSaluteNodeEvent"), typeof(TppRouteSaluteNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteSaluteNodeEvent(ulong id) : base(id) { }
		public TppRouteSaluteNodeEvent() : base() { }
