...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteVehicleGetInNodeEvent")]
	public partial class TppRouteVehicleGetInNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteVehicleGetInNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteVehicleGetInNodeEvent", typeof(TppRouteVehicleGetInNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
