...
namespace Tpp.GameKit
{
    ...
    public partial class TppCombatLocatorSetDataBody : Fox.Core.DataBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppCombatLocatorSetDataBody"), typeof(TppCombatLocatorSetDataBody), new Fox.Core.DataBody().GetClassEntityInfo(), 0, null, 0);
        }
