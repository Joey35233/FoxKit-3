...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionWalkAimFrontEdgeEvent")]
	public partial class TppRouteCautionWalkAimFrontEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteCautionWalkAimFrontEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionWalkAimFrontEdgeEvent", typeof(TppRouteCautionWalkAimFrontEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
