...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCautionSquatFireNodeEvent")]
	public partial class TppRouteCautionSquatFireNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCautionSquatFireNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCautionSquatFireNodeEvent", typeof(TppRouteCautionSquatFireNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
