...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteNoneEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteNoneEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteNoneEdgeEvent"), typeof(TppRouteNoneEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteNoneEdgeEvent(ulong id) : base(id) { }
		public TppRouteNoneEdgeEvent() : base() { }
