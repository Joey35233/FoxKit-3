...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteNoneEdgeEvent")]
	public partial class TppRouteNoneEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteNoneEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteNoneEdgeEvent", typeof(TppRouteNoneEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
