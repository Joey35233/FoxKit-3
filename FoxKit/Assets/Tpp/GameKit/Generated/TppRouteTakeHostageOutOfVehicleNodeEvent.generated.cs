	...
	public partial class TppRouteTakeHostageOutOfVehicleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteTakeHostageOutOfVehicleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteTakeHostageOutOfVehicleNodeEvent"), typeof(TppRouteTakeHostageOutOfVehicleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteTakeHostageOutOfVehicleNodeEvent(ulong id) : base(id) { }
		public TppRouteTakeHostageOutOfVehicleNodeEvent() : base() { }
