...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteSearchMissileNodeEvent")]
	public partial class TppRouteSearchMissileNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSearchMissileNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteSearchMissileNodeEvent", typeof(TppRouteSearchMissileNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
