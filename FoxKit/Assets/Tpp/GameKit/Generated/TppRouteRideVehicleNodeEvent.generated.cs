	...
	public partial class TppRouteRideVehicleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteRideVehicleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteRideVehicleNodeEvent"), typeof(TppRouteRideVehicleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
