	...
	public partial class TppRouteVehicleBackSlowEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent
	{
		...
		static TppRouteVehicleBackSlowEdgeEvent()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteVehicleBackSlowEdgeEvent"), typeof(TppRouteVehicleBackSlowEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteVehicleBackSlowEdgeEvent(ulong id) : base(id) { }
		public TppRouteVehicleBackSlowEdgeEvent() : base() { }
