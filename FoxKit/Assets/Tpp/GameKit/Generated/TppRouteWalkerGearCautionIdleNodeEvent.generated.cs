...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteWalkerGearCautionIdleNodeEvent")]
	public partial class TppRouteWalkerGearCautionIdleNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteWalkerGearCautionIdleNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteWalkerGearCautionIdleNodeEvent", typeof(TppRouteWalkerGearCautionIdleNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
