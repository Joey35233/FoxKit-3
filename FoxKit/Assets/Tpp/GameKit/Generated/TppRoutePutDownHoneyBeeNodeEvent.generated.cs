...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRoutePutDownHoneyBeeNodeEvent")]
	public partial class TppRoutePutDownHoneyBeeNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRoutePutDownHoneyBeeNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRoutePutDownHoneyBeeNodeEvent", typeof(TppRoutePutDownHoneyBeeNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
