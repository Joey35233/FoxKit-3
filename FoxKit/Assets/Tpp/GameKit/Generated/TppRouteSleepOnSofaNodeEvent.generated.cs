	...
	public partial class TppRouteSleepOnSofaNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteSleepOnSofaNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteSleepOnSofaNodeEvent"), typeof(TppRouteSleepOnSofaNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
