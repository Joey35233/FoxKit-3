	...
	public partial class TppPermanentGimmickImportantBreakableParameter : Fox.Core.DataElement
	{
		...
		static TppPermanentGimmickImportantBreakableParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppPermanentGimmickImportantBreakableParameter"), typeof(TppPermanentGimmickImportantBreakableParameter), Fox.Core.DataElement.ClassInfo, 40, null, 2);
