...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteCurtainOutNodeEvent")]
	public partial class TppRouteCurtainOutNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		...
		static TppRouteCurtainOutNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteCurtainOutNodeEvent", typeof(TppRouteCurtainOutNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
