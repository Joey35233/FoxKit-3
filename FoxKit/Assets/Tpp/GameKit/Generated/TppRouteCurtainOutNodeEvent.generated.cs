...
namespace Tpp.GameKit
{
	...
	public partial class TppRouteCurtainOutNodeEvent : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteCurtainOutNodeEvent()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteCurtainOutNodeEvent"), typeof(TppRouteCurtainOutNodeEvent), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
		...
		// Constructors
		public TppRouteCurtainOutNodeEvent(ulong id) : base(id) { }
		public TppRouteCurtainOutNodeEvent() : base() { }
