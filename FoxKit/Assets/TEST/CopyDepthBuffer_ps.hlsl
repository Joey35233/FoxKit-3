...
#line 3 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
...
#line 6 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"



#line 13 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
#define ENABLE_UV_SCALING

#line 16 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"





#line 21 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"


#line 40 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
...
#line 45 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"


#line 62 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"




#line 74 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"





#line 78 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"


#line 103 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"



#line 47 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
inline void NTex2D( float2 inTexCoord, Texture2D inTexture, out float4 outColor)
{
#line 53 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
    ...
    outColor = TFetch2D( inTexture, SamplerPoint, inTexCoord + g_psSystem.m_renderBuffer.zw * pixeloffset );
}



#line 65 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
inline void NClipToTextureCoordinate( float2 inClip, out float2 outTexcoord)
{
#line 70 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
    
   float2 texcoord = 0.5 * float2(inClip.x, -inClip.y) + 0.5;
   float2 scale = g_psSystem.m_renderInfo.xy * g_psSystem.m_renderBuffer.zw;
   outTexcoord = texcoord * scale;
}
...
#line 80 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
void ps_main(
...
#line 95 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
...
#line 96 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
	NTex2D_textureFetch_inTexCoord = NClipToTextureCoordinate_clipToTexcoord_outTexcoord ;
	NTex2D( NTex2D_textureFetch_inTexCoord, inTexture, NTex2D_textureFetch_outColor ) ;


#line 102 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
	outDepth = NTex2D_textureFetch_outColor.x ;

#line 101 "..\Gr\Dg\shader\CopyDepthBuffer.shdr"
