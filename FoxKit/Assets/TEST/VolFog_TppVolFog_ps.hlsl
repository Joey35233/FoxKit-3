...
#line 200 "shader\VolFog_TppVolFog.shdr"
	...
	const float3	skyLum		= g_psMaterial.m_materials[1].xyz; // J -  // (0.28209478*ATSH.c00 + 0.48860252*ATSH.c11 + 0.31539157*2*ATSH.c22)/Pi like tpp3dfw_generativeClouds_ps.hlsl) * TppGlobalVolumetricFog.skyAlbedo.rgb * (skyAlbedo.w = 1.0) * (unknown = 1.0) * TppGlobalVolumetricFog.luminance * fogExposure*pow(2, TppGlobalVolumetricFog.exposureOffset), FOR ambientColor - mgsvtpp.exe!140228ed2, https://cseweb.ucsd.edu/~ravir/papers/envmap/envmap.pdf, not sure why c22 is *2
