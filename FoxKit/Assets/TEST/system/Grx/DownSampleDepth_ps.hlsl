...
#line 6 "..\Gr\Dg\shader\DownSampleDepth.shdr"
...
#line 9 "..\Gr\Dg\shader\DownSampleDepth.shdr"
...
#line 15 "..\Gr\Dg\shader\DownSampleDepth.shdr"


#line 30 "..\Gr\Dg\shader\DownSampleDepth.shdr"




#line 50 "..\Gr\Dg\shader\DownSampleDepth.shdr"





#line 54 "..\Gr\Dg\shader\DownSampleDepth.shdr"


#line 65 "..\Gr\Dg\shader\DownSampleDepth.shdr"




#line 87 "..\Gr\Dg\shader\DownSampleDepth.shdr"




#line 106 "..\Gr\Dg\shader\DownSampleDepth.shdr"




#line 109 "..\Gr\Dg\shader\DownSampleDepth.shdr"


#line 144 "..\Gr\Dg\shader\DownSampleDepth.shdr"



#line 56 "..\Gr\Dg\shader\DownSampleDepth.shdr"
inline void NTex2DOffset(float2 inTexCoord, float2 inUVOffset, Texture2D inTexture, out float4 outColor)
{
#line 63 "..\Gr\Dg\shader\DownSampleDepth.shdr"
	outColor = TFetch2D(inTexture, SamplerPoint, inTexCoord + inUVOffset);  // J - Source buffer UVOffset; float2(0.5 / originalRenderTargetSize)
}



#line 90 "..\Gr\Dg\shader\DownSampleDepth.shdr"
inline void NScreenTexUvCancelCentral(float2 inUV, out float2 outUV)
{
#line 95 "..\Gr\Dg\shader\DownSampleDepth.shdr"

#ifdef DG_SUPPORT_FLEXIBLE_VIEWPORT
	inUV *= g_psSystem.m_renderInfo.xy * g_psSystem.m_renderBuffer.zw; // J - Both represent downsampled size (cancel each other out)
#endif
#ifdef DG_ENABLE_HALFPIXELOFFSET


	outUV = inUV - (float2(0.5f, 0.5f) * g_psSystem.m_renderBuffer.zw); // J - Get coordinates into [0, 1 - g_psSystem.m_renderBuffer.zw] (not halfpixel offset)
#else
	outUV = inUV;
#endif
}
...
Texture2D	NTex2DOffset_textureFetch_inTexture;
Texture2D	inTexture	:TEXUNIT0;
#line 111 "..\Gr\Dg\shader\DownSampleDepth.shdr"
void ps_main(

	in	float2	inTexCoord	: TEXCOORD0,
	out	half4	outColor : OUT_COLOR0,
	out	float	outDepth : OUT_DEPTH
)
{
	#include "../UnityPatch/PreEntryPoint.hlsl"

	float2	NScreenTexUvCancelCentral_texUvConvert_inUV;
	float2 NScreenTexUvCancelCentral_texUvConvert_outUV;
#line 128 "..\Gr\Dg\shader\DownSampleDepth.shdr"
	NScreenTexUvCancelCentral_texUvConvert_inUV = inTexCoord;
	NScreenTexUvCancelCentral(NScreenTexUvCancelCentral_texUvConvert_inUV, NScreenTexUvCancelCentral_texUvConvert_outUV);


	float2	NTex2DOffset_textureFetch_inTexCoord;
	float2	NTex2DOffset_textureFetch_inUVOffset;
	float4 NTex2DOffset_textureFetch_outColor;
#line 129 "..\Gr\Dg\shader\DownSampleDepth.shdr"
	NTex2DOffset_textureFetch_inTexCoord = NScreenTexUvCancelCentral_texUvConvert_outUV;
#line 131 "..\Gr\Dg\shader\DownSampleDepth.shdr"
	NTex2DOffset_textureFetch_inUVOffset = g_psObject.m_localParam[0].xy;
	NTex2DOffset(NTex2DOffset_textureFetch_inTexCoord, NTex2DOffset_textureFetch_inUVOffset, inTexture, NTex2DOffset_textureFetch_outColor);


#line 137 "..\Gr\Dg\shader\DownSampleDepth.shdr"
	outDepth = NTex2DOffset_textureFetch_outColor.x;

#line 136 "..\Gr\Dg\shader\DownSampleDepth.shdr"
