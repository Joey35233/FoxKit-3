...
#line 51 "..\Gr\Dg\shader\shadowDefine.h"
...
#line 57 "..\Gr\Dg\shader\Common.h"





#line 62 "..\Gr\Dg\shader\Common.h"
...
#line 26 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"
inline void NGenerateUvParameter(float2 inPosition, out float4 outUvParameter0)
{
#line 31 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"



	float2	viewportSize = g_vsObject.m_localParam[1].xy;
	float2	pixelToUv = g_vsObject.m_localParam[1].zw;
	float2	viewportUvArea = viewportSize.xy * pixelToUv.xy;


	outUvParameter0.xy = (inPosition * float2(0.5, -0.5) + float2(0.5, 0.5)) * viewportUvArea;


#ifndef DG_ENABLE_HALFPIXELOFFSET
	outUvParameter0.xy += float2(0.5, 0.5) * pixelToUv.xy;
#endif


	outUvParameter0.zw = pixelToUv.xy;
...
#line 54 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"
void vs_main(

	in	float2	inPosition	: POSITION,
	out	float4	outPosition : OUT_POSITION,
	out	float4	outUvParameter : TEXCOORD0
)
{
...
#line 65 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"
	...
	float2	NGenerateUvParameter_uvParameter_inPosition;
	float4 NGenerateUvParameter_uvParameter_outUvParameter0;
#line 68 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"
	NGenerateUvParameter_uvParameter_inPosition = NScreenCoordinateToDrawCoordinate_drawCoordinate_outPosition.xy;
	NGenerateUvParameter(NGenerateUvParameter_uvParameter_inPosition, NGenerateUvParameter_uvParameter_outUvParameter0);


#line 66 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"
	outPosition = NScreenCoordinateToDrawCoordinate_drawCoordinate_outPosition;

#line 69 "..\Gr\Dg\shader\blur_Gaussian1D_Bilateral_X.shdr"
	outUvParameter = NGenerateUvParameter_uvParameter_outUvParameter0;
