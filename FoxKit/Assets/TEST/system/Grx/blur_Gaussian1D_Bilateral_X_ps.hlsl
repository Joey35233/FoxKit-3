...
#line 65 "..\Gr\Dg\shader\blur_Gaussian1D_X.shdr"
inline void NGetUVMask(out float2 outUVMask)
{
#line 69 "..\Gr\Dg\shader\blur_Gaussian1D_X.shdr"

	outUVMask = float2(1, 0);
}
...
#ifdef F_TARGET_WIN32 // J - Clamp to max corner center (1 - 0.5/g_psSystem.m_renderBuffer.xy)
