...
namespace Fox.Ph
{
    public partial class PhClothVConstraintParam : Fox.Ph.PhConstraintParam 
    {
        ...
        {
            classInfo = new EntityInfo(new String("PhClothVConstraintParam"), base.GetClassEntityInfo(), 0, "Ph", 1);
			
			classInfo.StaticProperties.Insert(new String("limitedFlag"), new PropertyInfo(PropertyInfo.PropertyType.Bool, 100, 1, PropertyInfo.ContainerType.StaticArray, PropertyInfo.PropertyExport.Never, PropertyInfo.PropertyExport.Never, null, null, PropertyInfo.PropertyStorage.Instance));
			...
			classInfo.StaticProperties.Insert(new String("limit"), new PropertyInfo(PropertyInfo.PropertyType.Float, 96, 1, PropertyInfo.ContainerType.StaticArray, PropertyInfo.PropertyExport.Never, PropertyInfo.PropertyExport.Never, null, null, PropertyInfo.PropertyStorage.Instance));
        }

        // Constructor
		public PhClothVConstraintParam(ulong address, ushort idA, ushort idB) : base(address, idA, idB) { }
