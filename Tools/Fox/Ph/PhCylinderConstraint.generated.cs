...
namespace Fox.Ph
{
    ...
    public partial class PhCylinderConstraint : Fox.Ph.PhConstraint 
    {
        ...
        static PhCylinderConstraint()
        {
			...
			classInfo.StaticProperties.Insert("heightMin", new Fox.Core.PropertyInfo(Fox.Core.PropertyInfo.PropertyType.Float, 0, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
        ...
        // Constructors
		public PhCylinderConstraint(ulong address, ulong id) : base(address, id) { }
