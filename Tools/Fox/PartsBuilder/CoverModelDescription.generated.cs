...
namespace Fox.PartsBuilder
{
    ...
    public partial class CoverModelDescription : Fox.PartsBuilder.ModelDescription 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("CoverModelDescription", typeof(CoverModelDescription), new Fox.PartsBuilder.ModelDescription().GetClassEntityInfo(), 288, "PartsBuilder", 0);
        }
