...
namespace Fox.Core
{
    ...
    public partial class Matrix4ArrayPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("Matrix4ArrayPropertyDifference", typeof(Matrix4ArrayPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
