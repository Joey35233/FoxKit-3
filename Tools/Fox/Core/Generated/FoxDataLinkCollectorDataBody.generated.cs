    ...
    public partial class FoxDataLinkCollectorDataBody : Fox.Core.DataBody 
    {
        ...
        static FoxDataLinkCollectorDataBody()
        {
            if (Fox.Core.DataBody.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("FoxDataLinkCollectorDataBody"), typeof(FoxDataLinkCollectorDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
