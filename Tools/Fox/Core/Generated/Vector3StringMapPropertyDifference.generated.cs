...
namespace Fox.Core
{
    ...
    public partial class Vector3StringMapPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("Vector3StringMapPropertyDifference", typeof(Vector3StringMapPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
