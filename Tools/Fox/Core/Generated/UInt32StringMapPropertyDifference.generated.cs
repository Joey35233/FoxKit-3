...
namespace Fox.Core
{
    ...
    public partial class UInt32StringMapPropertyDifference : Fox.Core.PropertyDifference 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("UInt32StringMapPropertyDifference", typeof(UInt32StringMapPropertyDifference), new Fox.Core.PropertyDifference().GetClassEntityInfo(), 0, null, 0);
