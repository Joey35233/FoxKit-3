...
namespace Fox.Core
{
    ...
    {
        // Properties
        public UnityEngine.Vector3 pivotTransform_pivot;
        
        public UnityEngine.Vector3 pivotTransform_pivotTranslation;
        ...
        static PivotTransformEntity()
        {
			...
			classInfo.StaticProperties.Insert("pivot", new Fox.Core.PropertyInfo(Fox.Core.PropertyInfo.PropertyType.Vector3, 0, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance));
