    ...
    public partial class GkTacticalActionWaypoint : Fox.Core.DataElement 
    {
        ...
        static GkTacticalActionWaypoint()
        {
            if (Fox.Core.DataElement.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GkTacticalActionWaypoint"), typeof(GkTacticalActionWaypoint), Fox.Core.DataElement.ClassInfo, 48, "TacticalAction", 0);
