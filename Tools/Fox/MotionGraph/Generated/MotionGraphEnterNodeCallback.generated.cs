    ...
    public partial class MotionGraphEnterNodeCallback : Fox.Core.Entity 
    {
        ...
        static MotionGraphEnterNodeCallback()
        {
            if (Fox.Core.Entity.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("MotionGraphEnterNodeCallback"), typeof(MotionGraphEnterNodeCallback), Fox.Core.Entity.ClassInfo, 0, null, 0);
