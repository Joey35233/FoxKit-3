...
namespace Fox.GameService
{
    ...
    public partial class GsRouteDataRouteEventAimPoint : Fox.Core.DataElement 
    {
        // Properties
        ...
        static GsRouteDataRouteEventAimPoint()
        {
            if (Fox.Core.DataElement.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GsRouteDataRouteEventAimPoint"), typeof(GsRouteDataRouteEventAimPoint), Fox.Core.DataElement.ClassInfo, 0, null, 0);
        ...
        // Constructors
		public GsRouteDataRouteEventAimPoint(ulong id) : base(id) { }
		public GsRouteDataRouteEventAimPoint() : base() { }
