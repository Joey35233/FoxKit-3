...
namespace Fox.Geo
{
    ...
    public partial class GeoTrapModuleCallbackDataElement : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("GeoTrapModuleCallbackDataElement", typeof(GeoTrapModuleCallbackDataElement), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
