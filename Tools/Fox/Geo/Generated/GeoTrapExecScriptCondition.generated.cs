...
namespace Fox.Geo
{
    ...
    public partial class GeoTrapExecScriptCondition : Fox.Geo.GeoCheckModuleCondition 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("GeoTrapExecScriptCondition", typeof(GeoTrapExecScriptCondition), new Fox.Geo.GeoCheckModuleCondition().GetClassEntityInfo(), 0, "Trap", 0);
