...
namespace Fox.Geo
{
    ...
    public partial class GeoTrapScriptConditionBody : Fox.Geo.GeoTrapConditionBody 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("GeoTrapScriptConditionBody", typeof(GeoTrapScriptConditionBody), new Fox.Geo.GeoTrapConditionBody().GetClassEntityInfo(), 0, "Trap", 0);
