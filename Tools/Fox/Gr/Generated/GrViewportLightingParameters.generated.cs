    ...
    public partial class GrViewportLightingParameters : Fox.Gr.GrViewportParameter 
    {
        ...
        static GrViewportLightingParameters()
        {
            if (Fox.Gr.GrViewportParameter.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GrViewportLightingParameters"), typeof(GrViewportLightingParameters), Fox.Gr.GrViewportParameter.ClassInfo, 0, null, 0);
