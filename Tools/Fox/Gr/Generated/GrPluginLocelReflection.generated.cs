    ...
    public partial class GrPluginLocelReflection : Fox.Gr.GrRenderPlugin 
    {
        ...
        static GrPluginLocelReflection()
        {
            if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("GrPluginLocelReflection"), typeof(GrPluginLocelReflection), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
