    ...
    public partial class NavxNavFilterVolume : Fox.Graphx.GraphxPathVolume 
    {
        ...
        static NavxNavFilterVolume()
        {
            if (Fox.Graphx.GraphxPathVolume.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavxNavFilterVolume"), typeof(NavxNavFilterVolume), Fox.Graphx.GraphxPathVolume.ClassInfo, 320, null, 0);
