    ...
    public partial class NavxHoleSimplificationParameterVolumeBody : Fox.Core.TransformDataBody 
    {
        ...
        static NavxHoleSimplificationParameterVolumeBody()
        {
            if (Fox.Core.TransformDataBody.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("NavxHoleSimplificationParameterVolumeBody"), typeof(NavxHoleSimplificationParameterVolumeBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
