...
namespace Fox.Navx
{
    ...
    public partial class NavxWorldGenerateParameter : Fox.Core.TransformData 
    {
        ...
        {
            classInfo = new Fox.Core.EntityInfo("NavxWorldGenerateParameter", typeof(NavxWorldGenerateParameter), new Fox.Core.TransformData().GetClassEntityInfo(), 400, "Navx", 27);
