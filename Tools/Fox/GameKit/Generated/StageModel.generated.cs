...
namespace Fox.GameKit
{
    ...
    public partial class StageModel : Fox.Core.TransformData 
    {
        ...
        [field: UnityEngine.SerializeField]
        public Fox.Kernel.Path geomPath { get; set; }
        ...
        static StageModel()
        {
            classInfo = new Fox.Core.EntityInfo("StageModel", typeof(StageModel), new Fox.Core.TransformData().GetClassEntityInfo(), 0, "Model", 0);
