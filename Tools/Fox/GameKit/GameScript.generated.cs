...
namespace Fox.GameKit
{
    public partial class GameScript : Fox.Core.Data 
    {
        ...
        public StringMap<EntityLink> variables { get; } = new StringMap<EntityLink>();
        ...
        static GameScript()
        {
            classInfo = new EntityInfo(new String("GameScript"), base.GetClassEntityInfo(), 0, null, 0);
			...
			classInfo.StaticProperties.Insert(new String("variables"), new PropertyInfo(PropertyInfo.PropertyType.EntityLink, 136, 1, PropertyInfo.ContainerType.StringMap, PropertyInfo.PropertyExport.EditorAndGame, PropertyInfo.PropertyExport.EditorAndGame, null, null, PropertyInfo.PropertyStorage.Instance));
        }
