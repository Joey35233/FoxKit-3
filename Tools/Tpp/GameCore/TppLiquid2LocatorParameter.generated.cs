...
namespace Tpp.GameCore
{
    ...
    public partial class TppLiquid2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppLiquid2LocatorParameter", typeof(TppLiquid2LocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppLiquid2LocatorParameter(ulong address, ulong id) : base(address, id) { }
