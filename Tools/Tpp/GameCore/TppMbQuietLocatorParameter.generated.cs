...
namespace Tpp.GameCore
{
    ...
    public partial class TppMbQuietLocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppMbQuietLocatorParameter", typeof(TppMbQuietLocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppMbQuietLocatorParameter(ulong address, ulong id) : base(address, id) { }
