...
namespace Tpp.GameCore
{
    public partial class TppHorse2Parameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new EntityInfo(new String("TppHorse2Parameter"), base.GetClassEntityInfo(), 192, null, 4);
			...
			classInfo.StaticProperties.Insert(new String("fovaFiles"), new PropertyInfo(PropertyInfo.PropertyType.FilePtr, 200, 1, PropertyInfo.ContainerType.DynamicArray, PropertyInfo.PropertyExport.EditorAndGame, PropertyInfo.PropertyExport.EditorAndGame, null, null, PropertyInfo.PropertyStorage.Instance));
        }
