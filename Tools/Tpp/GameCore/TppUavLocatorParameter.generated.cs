...
namespace Tpp.GameCore
{
    ...
    public partial class TppUavLocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppUavLocatorParameter", typeof(TppUavLocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppUavLocatorParameter(ulong address, ulong id) : base(address, id) { }
