...
namespace Tpp.GameCore
{
    ...
    public partial class TppVolgin2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppVolgin2LocatorParameter", typeof(TppVolgin2LocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppVolgin2LocatorParameter(ulong address, ulong id) : base(address, id) { }
