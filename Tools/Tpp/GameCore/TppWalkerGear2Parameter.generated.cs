...
namespace Tpp.GameCore
{
    public partial class TppWalkerGear2Parameter : Fox.Core.DataElement 
    {
        ...
        public StringMap<FilePtr<File>> extraPartsFiles { get; } = new StringMap<FilePtr<File>>();
        ...
        {
            classInfo = new EntityInfo(new String("TppWalkerGear2Parameter"), base.GetClassEntityInfo(), 224, null, 0);
			...
			classInfo.StaticProperties.Insert(new String("extraPartsFiles"), new PropertyInfo(PropertyInfo.PropertyType.FilePtr, 200, 1, PropertyInfo.ContainerType.StringMap, PropertyInfo.PropertyExport.EditorAndGame, PropertyInfo.PropertyExport.EditorAndGame, null, null, PropertyInfo.PropertyStorage.Instance));
        }
