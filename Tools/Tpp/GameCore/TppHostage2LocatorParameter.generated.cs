...
namespace Tpp.GameCore
{
    ...
    public partial class TppHostage2LocatorParameter : Fox.Core.DataElement 
    {
        ...
        {
            classInfo = new Fox.EntityInfo("TppHostage2LocatorParameter", typeof(TppHostage2LocatorParameter), new Fox.Core.DataElement().GetClassEntityInfo(), 32, null, 0);
        ...
        // Constructors
		public TppHostage2LocatorParameter(ulong address, ulong id) : base(address, id) { }
