...
namespace Tpp.Effect
{
    public partial class TppPrimRiverModel : Fox.Core.Data 
    {
        ...
        {
            classInfo = new EntityInfo(new String("TppPrimRiverModel"), base.GetClassEntityInfo(), 96, null, 0);
			...
			classInfo.StaticProperties.Insert(new String("staticModels"), new PropertyInfo(PropertyInfo.PropertyType.EntityLink, 144, 1, PropertyInfo.ContainerType.DynamicArray, PropertyInfo.PropertyExport.EditorAndGame, PropertyInfo.PropertyExport.EditorAndGame, null, null, PropertyInfo.PropertyStorage.Instance));
        }
