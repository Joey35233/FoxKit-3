    ...
    public partial class TppRouteVehicleMoveFastEdgeEvent : Fox.GameService.GsRouteDataEdgeEvent 
    {
        ...
        static TppRouteVehicleMoveFastEdgeEvent()
        {
            if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
                classInfo = new Fox.Core.EntityInfo(new Fox.Kernel.String("TppRouteVehicleMoveFastEdgeEvent"), typeof(TppRouteVehicleMoveFastEdgeEvent), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
        ...
        // Constructors
		public TppRouteVehicleMoveFastEdgeEvent(ulong id) : base(id) { }
		public TppRouteVehicleMoveFastEdgeEvent() : base() { }
